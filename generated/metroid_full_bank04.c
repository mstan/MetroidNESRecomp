...
#endif
label_9A07:;
    /* $9A07: 0A */ nes_cpu_instruction_boundary(0x9A07, 2); g_cpu.C = (g_cpu.A>>7)&1; g_cpu.A = (g_cpu.A<<1)&0xFF; FLAG_NZ(g_cpu.A);
label_9A08:;
    /* $9A08: 04 */ nes_cpu_instruction_boundary(0x9A08, 3); (void)nes_read(0x4C); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9A0A:;
    /* $9A0A: DE */ nes_cpu_instruction_boundary(0x9A0A, 7); { uint16_t a=(0xBD99 + g_cpu.X) & 0xFFFF; uint8_t v=(nes_read(a)-1)&0xFF; nes_write(a,v); FLAG_NZ(v); }
label_9A0D:;
    /* $9A0D: 05 */ nes_cpu_instruction_boundary(0x9A0D, 3); g_cpu.A |= nes_read(0x04); FLAG_NZ(g_cpu.A);
label_9A0F:;
    /* $9A0F: 49 */ nes_cpu_instruction_boundary(0x9A0F, 2); g_cpu.A ^= 0x01; FLAG_NZ(g_cpu.A);
label_9A11:;
    /* $9A11: 9D */ nes_cpu_instruction_boundary(0x9A11, 5); nes_write((0x0405 + g_cpu.X) & 0xFFFF, g_cpu.A);
label_9A14:; /* RTS_Crawler06_BANK4 */
    /* $9A14: 60 */ nes_cpu_instruction_boundary(0x9A14, 6); { g_cpu.S++; uint8_t _rts_lo = g_ram[0x100 + g_cpu.S]; g_cpu.S++; uint8_t _rts_hi = g_ram[0x100 + g_cpu.S]; g_rts_target = (uint16_t)(((uint16_t)_rts_hi << 8) | _rts_lo); } /* pop JSR return address */
...
label_B3FA:;
    /* $B3FA: 20 */ nes_cpu_instruction_boundary(0xB3FA, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB3; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xFC; g_cpu.S--; func_B34B_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_B3FD:;
    /* $B3FD: 20 */ nes_cpu_instruction_boundary(0xB3FD, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB3; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xFF; g_cpu.S--; func_B37B_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_B400:;
    /* $B400: 20 */ nes_cpu_instruction_boundary(0xB400, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB4; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x02; g_cpu.S--; func_B36D_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_B403:;
    /* $B403: 20 */ nes_cpu_instruction_boundary(0xB403, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB4; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x05; g_cpu.S--; func_BC66_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B41B:; /* SoundEngine_SilenceMusic */
    /* $B41B: 20 */ nes_cpu_instruction_boundary(0xB41B, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB4; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x1D; g_cpu.S--; func_B434_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B434:; /* InitializeSoundAddresses */
    /* $B434: 20 */ nes_cpu_instruction_boundary(0xB434, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB4; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x36; g_cpu.S--; func_B44D_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_B437:;
    /* $B437: 20 */ nes_cpu_instruction_boundary(0xB437, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB4; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x39; g_cpu.S--; func_B46E_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B43A:; /* GotoClearSpecialAddresses */
    /* $B43A: 20 */ nes_cpu_instruction_boundary(0xB43A, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB4; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x3C; g_cpu.S--; func_B43E_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B3DD:;
    /* $B3DD: 20 */ nes_cpu_instruction_boundary(0xB3DD, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB3; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xDF; g_cpu.S--; func_B398_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
void func_B34B_b4_body(int _entry) { /* RunSFXNoiseInitRoutine */
    switch (_entry) {
...
label_B367:; /* RunSoundRoutine */
    /* $B367: 20 */ nes_cpu_instruction_boundary(0xB367, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB3; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x69; g_cpu.S--; func_B4ED_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B380:;
    /* $B380: 20 */ nes_cpu_instruction_boundary(0xB380, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB3; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x82; g_cpu.S--; func_B4ED_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_B383:;
    /* $B383: 20 */ nes_cpu_instruction_boundary(0xB383, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB3; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x85; g_cpu.S--; func_BC83_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_B386:;
    /* $B386: 20 */ nes_cpu_instruction_boundary(0xB386, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB3; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x88; g_cpu.S--; func_BC94_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_BC72:; /* RunMusicInitRoutine_Common */
    /* $BC72: 20 */ nes_cpu_instruction_boundary(0xBC72, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xBC; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x74; g_cpu.S--; func_B4ED_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_BC75:;
    /* $BC75: 20 */ nes_cpu_instruction_boundary(0xBC75, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xBC; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x77; g_cpu.S--; func_BC83_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
void func_B44D_b4_body(int _entry) { /* ClearMusicAndSFXAddresses */
    switch (_entry) {
...
#ifdef RECOMP_STACK_TRACKING
    recomp_stack_push("func_9923_b4");
#endif
label_9923:;
    /* $9923: F4 */ nes_cpu_instruction_boundary(0x9923, 4); (void)nes_read((0x6A + g_cpu.X) & 0xFF); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9925:;
    /* $9925: C9 */ nes_cpu_instruction_boundary(0x9925, 2); { int r=g_cpu.A-0x03; g_cpu.C=(g_cpu.A>=0x03)?1:0; FLAG_NZ(r&0xFF); }
label_9927:;
    /* $9927: F0 */ nes_cpu_instruction_boundary(0x9927, 2); if (g_cpu.Z) { maybe_trigger_vblank(1); goto label_992C; }
label_9929:;
    /* $9929: 20 */ nes_cpu_instruction_boundary(0x9929, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x99; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x2B; g_cpu.S--; func_801B_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
#endif
    return; } }
label_992C:; /* CommonEnemyStub2_BANK4 */
    /* $992C: A9 */ nes_cpu_instruction_boundary(0x992C, 2); g_cpu.A = 0x06; FLAG_NZ(g_cpu.A);
label_992E:;
    /* $992E: 85 */ nes_cpu_instruction_boundary(0x992E, 3); nes_write(0x00, g_cpu.A);
label_9930:; /* CommonEnemyStub_BANK4 */
    /* $9930: A9 */ nes_cpu_instruction_boundary(0x9930, 2); g_cpu.A = 0x08; FLAG_NZ(g_cpu.A);
label_9932:;
    /* $9932: 85 */ nes_cpu_instruction_boundary(0x9932, 3); nes_write(0x01, g_cpu.A);
label_9934:;
    /* $9934: 4C */ nes_cpu_instruction_boundary(0x9934, 3); nes_cpu_instruction_boundary(0x9905, 2); func_9905_b4(); return;
}
...
#endif
label_9905:; /* UpdateEnemyCommon_Decide_BANK4 */
    /* $9905: A5 */ nes_cpu_instruction_boundary(0x9905, 3); g_cpu.A = nes_read(0x81); FLAG_NZ(g_cpu.A);
label_9907:;
    /* $9907: C9 */ nes_cpu_instruction_boundary(0x9907, 2); { int r=g_cpu.A-0x01; g_cpu.C=(g_cpu.A>=0x01)?1:0; FLAG_NZ(r&0xFF); }
label_9909:;
    /* $9909: F0 */ nes_cpu_instruction_boundary(0x9909, 2); if (g_cpu.Z) { maybe_trigger_vblank(1); goto label_9914; }
label_990B:;
    /* $990B: C9 */ nes_cpu_instruction_boundary(0x990B, 2); { int r=g_cpu.A-0x03; g_cpu.C=(g_cpu.A>=0x03)?1:0; FLAG_NZ(r&0xFF); }
label_990D:;
    /* $990D: F0 */ nes_cpu_instruction_boundary(0x990D, 2); if (g_cpu.Z) { maybe_trigger_vblank(1); goto label_9919; }
label_990F:;
    /* $990F: A5 */ nes_cpu_instruction_boundary(0x990F, 3); g_cpu.A = nes_read(0x00); FLAG_NZ(g_cpu.A);
label_9911:;
    /* $9911: 4C */ nes_cpu_instruction_boundary(0x9911, 3); nes_cpu_instruction_boundary(0x8000, 2); func_8000_b4(); return;
label_9914:; /* UpdateEnemyCommon_Decide_BANK4_resting */
    /* $9914: A5 */ nes_cpu_instruction_boundary(0x9914, 3); g_cpu.A = nes_read(0x01); FLAG_NZ(g_cpu.A);
label_9916:;
    /* $9916: 4C */ nes_cpu_instruction_boundary(0x9916, 3); nes_cpu_instruction_boundary(0x8003, 2); func_8003_b4(); return;
label_9919:; /* UpdateEnemyCommon_Decide_BANK4_explode */
    /* $9919: 4C */ nes_cpu_instruction_boundary(0x9919, 3); nes_cpu_instruction_boundary(0x8006, 2); func_8006_b4(); return;
}
...
#endif
label_991E:; /* Sidehopper_Common_BANK4 */
    /* $991E: 85 */ nes_cpu_instruction_boundary(0x991E, 3); nes_write(0x85, g_cpu.A);
label_9920:;
    /* $9920: 85 */ nes_cpu_instruction_boundary(0x9920, 3); nes_write(0x86, g_cpu.A);
label_9922:;
    /* $9922: BD */ nes_cpu_instruction_boundary(0x9922, 4); g_cpu.A = nes_read((0x6AF4 + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9925:;
    /* $9925: C9 */ nes_cpu_instruction_boundary(0x9925, 2); { int r=g_cpu.A-0x03; g_cpu.C=(g_cpu.A>=0x03)?1:0; FLAG_NZ(r&0xFF); }
label_9927:;
    /* $9927: F0 */ nes_cpu_instruction_boundary(0x9927, 2); if (g_cpu.Z) { maybe_trigger_vblank(1); goto label_992C; }
...
#endif
label_9A31:; /* JumpByRTSToMovementRoutine_BANK4 */
    /* $9A31: BC */ nes_cpu_instruction_boundary(0x9A31, 4); g_cpu.Y = nes_read((0x0405 + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.Y);
label_9A34:;
    /* $9A34: 84 */ nes_cpu_instruction_boundary(0x9A34, 3); nes_write(0x00, g_cpu.Y);
label_9A36:;
    /* $9A36: 46 */ nes_cpu_instruction_boundary(0x9A36, 5); { uint16_t a=0x00; uint8_t v=nes_read(a); g_cpu.C=v&1; v>>=1; nes_write(a,v); FLAG_NZ(v); }
label_9A38:;
    /* $9A38: 2A */ nes_cpu_instruction_boundary(0x9A38, 2); { uint8_t c=g_cpu.C; g_cpu.C=(g_cpu.A>>7)&1; g_cpu.A=((g_cpu.A<<1)|c)&0xFF; FLAG_NZ(g_cpu.A); }
label_9A39:;
    /* $9A39: 0A */ nes_cpu_instruction_boundary(0x9A39, 2); g_cpu.C = (g_cpu.A>>7)&1; g_cpu.A = (g_cpu.A<<1)&0xFF; FLAG_NZ(g_cpu.A);
label_9A3A:;
    /* $9A3A: A8 */ nes_cpu_instruction_boundary(0x9A3A, 2); g_cpu.Y = g_cpu.A; FLAG_NZ(g_cpu.Y);
label_9A3B:;
    /* $9A3B: B9 */ nes_cpu_instruction_boundary(0x9A3B, 4); g_cpu.A = nes_read((0x8049 + g_cpu.Y) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9A3E:;
    /* $9A3E: 48 */ nes_cpu_instruction_boundary(0x9A3E, 3); g_ram[0x100 + g_cpu.S] = g_cpu.A; g_cpu.S--;
label_9A3F:;
    /* $9A3F: B9 */ nes_cpu_instruction_boundary(0x9A3F, 4); g_cpu.A = nes_read((0x8048 + g_cpu.Y) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9A42:;
    /* $9A42: 48 */ nes_cpu_instruction_boundary(0x9A42, 3); g_ram[0x100 + g_cpu.S] = g_cpu.A; g_cpu.S--;
label_9A43:;
    /* $9A43: 60 */ nes_cpu_instruction_boundary(0x9A43, 6); { g_cpu.S++; uint8_t _lo=g_ram[0x100+g_cpu.S]; g_cpu.S++; uint8_t _hi=g_ram[0x100+g_cpu.S]; call_by_address_tail(((uint16_t)_hi<<8|_lo)+1, -1); }
...
void func_99F7_b4_body(int _entry) { /* CrawlerInsideCornerCheck_BANK4 */
    switch (_entry) {
        case 1: goto label_9A0C;
    }
label_99F7:; /* CrawlerInsideCornerCheck_BANK4 */
    /* $99F7: A6 */ nes_cpu_instruction_boundary(0x99F7, 3); g_cpu.X = nes_read(0x4B); FLAG_NZ(g_cpu.X);
label_99F9:;
    /* $99F9: B0 */ nes_cpu_instruction_boundary(0x99F9, 2); if (g_cpu.C) { maybe_trigger_vblank(2); goto label_9A14; }
label_99FB:;
    /* $99FB: A5 */ nes_cpu_instruction_boundary(0x99FB, 3); g_cpu.A = nes_read(0x00); FLAG_NZ(g_cpu.A);
label_99FD:;
    /* $99FD: D0 */ nes_cpu_instruction_boundary(0x99FD, 2); if (!g_cpu.Z) { maybe_trigger_vblank(2); goto label_9A0C; }
label_99FF:;
    /* $99FF: BC */ nes_cpu_instruction_boundary(0x99FF, 4); g_cpu.Y = nes_read((0x040A + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.Y);
label_9A02:;
    /* $9A02: 88 */ nes_cpu_instruction_boundary(0x9A02, 2); g_cpu.Y = (g_cpu.Y-1)&0xFF; FLAG_NZ(g_cpu.Y);
label_9A03:;
    /* $9A03: 98 */ nes_cpu_instruction_boundary(0x9A03, 2); g_cpu.A = g_cpu.Y; FLAG_NZ(g_cpu.A);
label_9A04:;
    /* $9A04: 29 */ nes_cpu_instruction_boundary(0x9A04, 2); g_cpu.A &= 0x03; FLAG_NZ(g_cpu.A);
label_9A06:;
    /* $9A06: 9D */ nes_cpu_instruction_boundary(0x9A06, 5); nes_write((0x040A + g_cpu.X) & 0xFFFF, g_cpu.A);
label_9A09:;
    /* $9A09: 4C */ nes_cpu_instruction_boundary(0x9A09, 3); nes_cpu_instruction_boundary(0x99DE, 2); func_99DE_b4(); return;
label_9A0C:; /* CrawlerFlipDirection_BANK4 */
    /* $9A0C: BD */ nes_cpu_instruction_boundary(0x9A0C, 4); g_cpu.A = nes_read((0x0405 + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9A0F:;
    /* $9A0F: 49 */ nes_cpu_instruction_boundary(0x9A0F, 2); g_cpu.A ^= 0x01; FLAG_NZ(g_cpu.A);
label_9A11:;
    /* $9A11: 9D */ nes_cpu_instruction_boundary(0x9A11, 5); nes_write((0x0405 + g_cpu.X) & 0xFFFF, g_cpu.A);
...
#endif
label_9A15:; /* CrawlerOutsideCornerCheck_BANK4 */
    /* $9A15: 20 */ nes_cpu_instruction_boundary(0x9A15, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x9A; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x17; g_cpu.S--; func_9A29_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_9A18:;
    /* $9A18: 20 */ nes_cpu_instruction_boundary(0x9A18, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x9A; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x1A; g_cpu.S--; func_9A31_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_9A1B:;
    /* $9A1B: A6 */ nes_cpu_instruction_boundary(0x9A1B, 3); g_cpu.X = nes_read(0x4B); FLAG_NZ(g_cpu.X);
label_9A1D:;
    /* $9A1D: 90 */ nes_cpu_instruction_boundary(0x9A1D, 2); if (!g_cpu.C) { maybe_trigger_vblank(1); goto label_9A28; }
label_9A1F:;
    /* $9A1F: 20 */ nes_cpu_instruction_boundary(0x9A1F, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x9A; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x21; g_cpu.S--; func_9A29_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_9A22:;
    /* $9A22: 9D */ nes_cpu_instruction_boundary(0x9A22, 5); nes_write((0x040A + g_cpu.X) & 0xFFFF, g_cpu.A);
label_9A25:;
    /* $9A25: 20 */ nes_cpu_instruction_boundary(0x9A25, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x9A; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x27; g_cpu.S--; func_99DE_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
#endif
    return; } }
label_9A28:; /* CrawlerOutsideCornerCheck_BANK4_RTS */
    /* $9A28: 60 */ nes_cpu_instruction_boundary(0x9A28, 6); { g_cpu.S++; uint8_t _rts_lo = g_ram[0x100 + g_cpu.S]; g_cpu.S++; uint8_t _rts_hi = g_ram[0x100 + g_cpu.S]; g_rts_target = (uint16_t)(((uint16_t)_rts_hi << 8) | _rts_lo); } /* pop JSR return address */
...
#endif
label_99DE:; /* CrawlerReorientSprite_BANK4 */
    /* $99DE: BD */ nes_cpu_instruction_boundary(0x99DE, 4); g_cpu.A = nes_read((0x0405 + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_99E1:;
    /* $99E1: 4A */ nes_cpu_instruction_boundary(0x99E1, 2); g_cpu.C = g_cpu.A&1; g_cpu.A >>= 1; FLAG_NZ(g_cpu.A);
label_99E2:;
    /* $99E2: BD */ nes_cpu_instruction_boundary(0x99E2, 4); g_cpu.A = nes_read((0x040A + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_99E5:;
    /* $99E5: 29 */ nes_cpu_instruction_boundary(0x99E5, 2); g_cpu.A &= 0x03; FLAG_NZ(g_cpu.A);
label_99E7:;
    /* $99E7: 2A */ nes_cpu_instruction_boundary(0x99E7, 2); { uint8_t c=g_cpu.C; g_cpu.C=(g_cpu.A>>7)&1; g_cpu.A=((g_cpu.A<<1)|c)&0xFF; FLAG_NZ(g_cpu.A); }
label_99E8:;
    /* $99E8: A8 */ nes_cpu_instruction_boundary(0x99E8, 2); g_cpu.Y = g_cpu.A; FLAG_NZ(g_cpu.Y);
label_99E9:;
    /* $99E9: B9 */ nes_cpu_instruction_boundary(0x99E9, 4); g_cpu.A = nes_read((0x99EF + g_cpu.Y) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_99EC:;
    /* $99EC: 4C */ nes_cpu_instruction_boundary(0x99EC, 3); nes_cpu_instruction_boundary(0x800F, 2); func_800F_b4(); return;
}
...
#endif
label_9A29:; /* CrawlerOutsideCornerGetNextOrientation_BANK4 */
    /* $9A29: BC */ nes_cpu_instruction_boundary(0x9A29, 4); g_cpu.Y = nes_read((0x040A + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.Y);
label_9A2C:;
    /* $9A2C: C8 */ nes_cpu_instruction_boundary(0x9A2C, 2); g_cpu.Y = (g_cpu.Y+1)&0xFF; FLAG_NZ(g_cpu.Y);
label_9A2D:;
    /* $9A2D: 98 */ nes_cpu_instruction_boundary(0x9A2D, 2); g_cpu.A = g_cpu.Y; FLAG_NZ(g_cpu.A);
label_9A2E:;
    /* $9A2E: 29 */ nes_cpu_instruction_boundary(0x9A2E, 2); g_cpu.A &= 0x03; FLAG_NZ(g_cpu.A);
label_9A30:;
    /* $9A30: 60 */ nes_cpu_instruction_boundary(0x9A30, 6); { g_cpu.S++; uint8_t _rts_lo = g_ram[0x100 + g_cpu.S]; g_cpu.S++; uint8_t _rts_hi = g_ram[0x100 + g_cpu.S]; g_rts_target = (uint16_t)(((uint16_t)_rts_hi << 8) | _rts_lo); } /* pop JSR return address */
...
label_8036:; /* CommonJump_EnemyGetDeltaY_UsingAcceleration */
    /* $8036: 4C */ nes_cpu_instruction_boundary(0x8036, 3); nes_cpu_instruction_boundary(0x833F, 2); func_833F_b4(); return;
}
...
label_8039:; /* CommonJump_EnemyGetDeltaX_UsingAcceleration */
    /* $8039: 4C */ nes_cpu_instruction_boundary(0x8039, 3); nes_cpu_instruction_boundary(0x8395, 2); func_8395_b4(); return;
}
...
#endif
label_9BBC:; /* StoreEnemyPositionToTemp__BANK4 */
    /* $9BBC: BD */ nes_cpu_instruction_boundary(0x9BBC, 4); g_cpu.A = nes_read((0x0400 + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9BBF:;
    /* $9BBF: 85 */ nes_cpu_instruction_boundary(0x9BBF, 3); nes_write(0x08, g_cpu.A);
label_9BC1:;
    /* $9BC1: BD */ nes_cpu_instruction_boundary(0x9BC1, 4); g_cpu.A = nes_read((0x0401 + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9BC4:;
    /* $9BC4: 85 */ nes_cpu_instruction_boundary(0x9BC4, 3); nes_write(0x09, g_cpu.A);
label_9BC6:;
    /* $9BC6: BD */ nes_cpu_instruction_boundary(0x9BC6, 4); g_cpu.A = nes_read((0x6AFB + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9BC9:;
    /* $9BC9: 85 */ nes_cpu_instruction_boundary(0x9BC9, 3); nes_write(0x0B, g_cpu.A);
label_9BCB:;
    /* $9BCB: 60 */ nes_cpu_instruction_boundary(0x9BCB, 6); { g_cpu.S++; uint8_t _rts_lo = g_ram[0x100 + g_cpu.S]; g_cpu.S++; uint8_t _rts_hi = g_ram[0x100 + g_cpu.S]; g_rts_target = (uint16_t)(((uint16_t)_rts_hi << 8) | _rts_lo); } /* pop JSR return address */
...
#endif
label_9B2F:; /* KraidUpdateAllProjectiles_BANK4 */
    /* $9B2F: A2 */ nes_cpu_instruction_boundary(0x9B2F, 2); g_cpu.X = 0x50; FLAG_NZ(g_cpu.X);
label_9B31:; /* KraidUpdateAllProjectiles_BANK4_loop */
    /* $9B31: 20 */ nes_cpu_instruction_boundary(0x9B31, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x9B; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x33; g_cpu.S--; func_9B3C_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_9B34:;
    /* $9B34: 8A */ nes_cpu_instruction_boundary(0x9B34, 2); g_cpu.A = g_cpu.X; FLAG_NZ(g_cpu.A);
label_9B35:;
    /* $9B35: 38 */ nes_cpu_instruction_boundary(0x9B35, 2); g_cpu.C = 1;
label_9B36:;
    /* $9B36: E9 */ nes_cpu_instruction_boundary(0x9B36, 2); { uint8_t m=0x10; int16_t r=g_cpu.A-m-(1-g_cpu.C); FLAG_NZC_SUB(r,g_cpu.A,m); g_cpu.A=r&0xFF; }
label_9B38:;
    /* $9B38: AA */ nes_cpu_instruction_boundary(0x9B38, 2); g_cpu.X = g_cpu.A; FLAG_NZ(g_cpu.X);
label_9B39:;
    /* $9B39: D0 */ nes_cpu_instruction_boundary(0x9B39, 2); if (!g_cpu.Z) {
    nes_cpu_instruction_boundary(0x9B31, 1);
#ifdef WATCHDOG_ENABLED
    watchdog_check();
#endif
    goto label_9B31;
...
label_9B3B:;
    /* $9B3B: 60 */ nes_cpu_instruction_boundary(0x9B3B, 6); { g_cpu.S++; uint8_t _rts_lo = g_ram[0x100 + g_cpu.S]; g_cpu.S++; uint8_t _rts_hi = g_ram[0x100 + g_cpu.S]; g_rts_target = (uint16_t)(((uint16_t)_rts_hi << 8) | _rts_lo); } /* pop JSR return address */
...
#endif
label_9BE0:; /* KraidTryToLaunchLint_BANK4 */
    /* $9BE0: A4 */ nes_cpu_instruction_boundary(0x9BE0, 3); g_cpu.Y = nes_read(0x7E); FLAG_NZ(g_cpu.Y);
label_9BE2:;
    /* $9BE2: D0 */ nes_cpu_instruction_boundary(0x9BE2, 2); if (!g_cpu.Z) { maybe_trigger_vblank(1); goto label_9BE6; }
label_9BE4:;
    /* $9BE4: A0 */ nes_cpu_instruction_boundary(0x9BE4, 2); g_cpu.Y = 0x80; FLAG_NZ(g_cpu.Y);
label_9BE6:; /* KraidTryToLaunchLint_BANK4_endIf_A */
    /* $9BE6: A5 */ nes_cpu_instruction_boundary(0x9BE6, 3); g_cpu.A = nes_read(0x2D); FLAG_NZ(g_cpu.A);
label_9BE8:;
    /* $9BE8: 29 */ nes_cpu_instruction_boundary(0x9BE8, 2); g_cpu.A &= 0x02; FLAG_NZ(g_cpu.A);
label_9BEA:;
    /* $9BEA: D0 */ nes_cpu_instruction_boundary(0x9BEA, 2); if (!g_cpu.Z) { maybe_trigger_vblank(2); goto label_9C18; }
label_9BEC:;
    /* $9BEC: 88 */ nes_cpu_instruction_boundary(0x9BEC, 2); g_cpu.Y = (g_cpu.Y-1)&0xFF; FLAG_NZ(g_cpu.Y);
label_9BED:;
    /* $9BED: 84 */ nes_cpu_instruction_boundary(0x9BED, 3); nes_write(0x7E, g_cpu.Y);
label_9BEF:;
    /* $9BEF: 98 */ nes_cpu_instruction_boundary(0x9BEF, 2); g_cpu.A = g_cpu.Y; FLAG_NZ(g_cpu.A);
label_9BF0:;
    /* $9BF0: 0A */ nes_cpu_instruction_boundary(0x9BF0, 2); g_cpu.C = (g_cpu.A>>7)&1; g_cpu.A = (g_cpu.A<<1)&0xFF; FLAG_NZ(g_cpu.A);
label_9BF1:;
    /* $9BF1: 30 */ nes_cpu_instruction_boundary(0x9BF1, 2); if (g_cpu.N) { maybe_trigger_vblank(2); goto label_9C18; }
label_9BF3:;
    /* $9BF3: 29 */ nes_cpu_instruction_boundary(0x9BF3, 2); g_cpu.A &= 0x0F; FLAG_NZ(g_cpu.A);
label_9BF5:;
    /* $9BF5: C9 */ nes_cpu_instruction_boundary(0x9BF5, 2); { int r=g_cpu.A-0x0A; g_cpu.C=(g_cpu.A>=0x0A)?1:0; FLAG_NZ(r&0xFF); }
label_9BF7:;
    /* $9BF7: D0 */ nes_cpu_instruction_boundary(0x9BF7, 2); if (!g_cpu.Z) { maybe_trigger_vblank(2); goto label_9C18; }
label_9BF9:;
    /* $9BF9: A9 */ nes_cpu_instruction_boundary(0x9BF9, 2); g_cpu.A = 0x01; FLAG_NZ(g_cpu.A);
label_9BFB:;
    /* $9BFB: A2 */ nes_cpu_instruction_boundary(0x9BFB, 2); g_cpu.X = 0x10; FLAG_NZ(g_cpu.X);
label_9BFD:;
    /* $9BFD: DD */ nes_cpu_instruction_boundary(0x9BFD, 4); { uint8_t m=nes_read((0x6AF4 + g_cpu.X) & 0xFFFF); int r=g_cpu.A-m; g_cpu.C=(g_cpu.A>=m)?1:0; FLAG_NZ(r&0xFF); }
label_9C00:;
    /* $9C00: F0 */ nes_cpu_instruction_boundary(0x9C00, 2); if (g_cpu.Z) { maybe_trigger_vblank(1); goto label_9C13; }
label_9C02:;
    /* $9C02: A2 */ nes_cpu_instruction_boundary(0x9C02, 2); g_cpu.X = 0x20; FLAG_NZ(g_cpu.X);
label_9C04:;
    /* $9C04: DD */ nes_cpu_instruction_boundary(0x9C04, 4); { uint8_t m=nes_read((0x6AF4 + g_cpu.X) & 0xFFFF); int r=g_cpu.A-m; g_cpu.C=(g_cpu.A>=m)?1:0; FLAG_NZ(r&0xFF); }
label_9C07:;
    /* $9C07: F0 */ nes_cpu_instruction_boundary(0x9C07, 2); if (g_cpu.Z) { maybe_trigger_vblank(1); goto label_9C13; }
label_9C09:;
    /* $9C09: A2 */ nes_cpu_instruction_boundary(0x9C09, 2); g_cpu.X = 0x30; FLAG_NZ(g_cpu.X);
label_9C0B:;
    /* $9C0B: DD */ nes_cpu_instruction_boundary(0x9C0B, 4); { uint8_t m=nes_read((0x6AF4 + g_cpu.X) & 0xFFFF); int r=g_cpu.A-m; g_cpu.C=(g_cpu.A>=m)?1:0; FLAG_NZ(r&0xFF); }
label_9C0E:;
    /* $9C0E: F0 */ nes_cpu_instruction_boundary(0x9C0E, 2); if (g_cpu.Z) { maybe_trigger_vblank(1); goto label_9C13; }
label_9C10:;
    /* $9C10: E6 */ nes_cpu_instruction_boundary(0x9C10, 5); { uint16_t a=0x7E; uint8_t v=(nes_read(a)+1)&0xFF; nes_write(a,v); FLAG_NZ(v); }
label_9C12:;
    /* $9C12: 60 */ nes_cpu_instruction_boundary(0x9C12, 6); { g_cpu.S++; uint8_t _rts_lo = g_ram[0x100 + g_cpu.S]; g_cpu.S++; uint8_t _rts_hi = g_ram[0x100 + g_cpu.S]; g_rts_target = (uint16_t)(((uint16_t)_rts_hi << 8) | _rts_lo); } /* pop JSR return address */

#ifdef RECOMP_STACK_TRACKING
    recomp_stack_pop();
#endif
    return;
label_9C13:; /* KraidTryToLaunchLint_BANK4_primeForLaunch */
    /* $9C13: A9 */ nes_cpu_instruction_boundary(0x9C13, 2); g_cpu.A = 0x08; FLAG_NZ(g_cpu.A);
label_9C15:;
    /* $9C15: 9D */ nes_cpu_instruction_boundary(0x9C15, 5); nes_write((0x0409 + g_cpu.X) & 0xFFFF, g_cpu.A);
label_9C18:; /* KraidTryToLaunchLint_BANK4_RTS */
    /* $9C18: 60 */ nes_cpu_instruction_boundary(0x9C18, 6); { g_cpu.S++; uint8_t _rts_lo = g_ram[0x100 + g_cpu.S]; g_cpu.S++; uint8_t _rts_hi = g_ram[0x100 + g_cpu.S]; g_rts_target = (uint16_t)(((uint16_t)_rts_hi << 8) | _rts_lo); } /* pop JSR return address */
...
#endif
label_9C19:; /* KraidTryToLaunchNail_BANK4 */
    /* $9C19: A4 */ nes_cpu_instruction_boundary(0x9C19, 3); g_cpu.Y = nes_read(0x7F); FLAG_NZ(g_cpu.Y);
label_9C1B:;
    /* $9C1B: D0 */ nes_cpu_instruction_boundary(0x9C1B, 2); if (!g_cpu.Z) { maybe_trigger_vblank(1); goto label_9C1F; }
label_9C1D:;
    /* $9C1D: A0 */ nes_cpu_instruction_boundary(0x9C1D, 2); g_cpu.Y = 0x60; FLAG_NZ(g_cpu.Y);
label_9C1F:; /* KraidTryToLaunchNail_BANK4_endIf_A */
    /* $9C1F: A5 */ nes_cpu_instruction_boundary(0x9C1F, 3); g_cpu.A = nes_read(0x2D); FLAG_NZ(g_cpu.A);
label_9C21:;
    /* $9C21: 29 */ nes_cpu_instruction_boundary(0x9C21, 2); g_cpu.A &= 0x02; FLAG_NZ(g_cpu.A);
label_9C23:;
    /* $9C23: D0 */ nes_cpu_instruction_boundary(0x9C23, 2); if (!g_cpu.Z) { maybe_trigger_vblank(1); goto label_9C48; }
label_9C25:;
    /* $9C25: 88 */ nes_cpu_instruction_boundary(0x9C25, 2); g_cpu.Y = (g_cpu.Y-1)&0xFF; FLAG_NZ(g_cpu.Y);
label_9C26:;
    /* $9C26: 84 */ nes_cpu_instruction_boundary(0x9C26, 3); nes_write(0x7F, g_cpu.Y);
label_9C28:;
    /* $9C28: 98 */ nes_cpu_instruction_boundary(0x9C28, 2); g_cpu.A = g_cpu.Y; FLAG_NZ(g_cpu.A);
label_9C29:;
    /* $9C29: 0A */ nes_cpu_instruction_boundary(0x9C29, 2); g_cpu.C = (g_cpu.A>>7)&1; g_cpu.A = (g_cpu.A<<1)&0xFF; FLAG_NZ(g_cpu.A);
label_9C2A:;
    /* $9C2A: 30 */ nes_cpu_instruction_boundary(0x9C2A, 2); if (g_cpu.N) { maybe_trigger_vblank(1); goto label_9C48; }
label_9C2C:;
    /* $9C2C: 29 */ nes_cpu_instruction_boundary(0x9C2C, 2); g_cpu.A &= 0x0F; FLAG_NZ(g_cpu.A);
label_9C2E:;
    /* $9C2E: D0 */ nes_cpu_instruction_boundary(0x9C2E, 2); if (!g_cpu.Z) { maybe_trigger_vblank(1); goto label_9C48; }
label_9C30:;
    /* $9C30: A9 */ nes_cpu_instruction_boundary(0x9C30, 2); g_cpu.A = 0x01; FLAG_NZ(g_cpu.A);
label_9C32:;
    /* $9C32: A2 */ nes_cpu_instruction_boundary(0x9C32, 2); g_cpu.X = 0x40; FLAG_NZ(g_cpu.X);
label_9C34:;
    /* $9C34: DD */ nes_cpu_instruction_boundary(0x9C34, 4); { uint8_t m=nes_read((0x6AF4 + g_cpu.X) & 0xFFFF); int r=g_cpu.A-m; g_cpu.C=(g_cpu.A>=m)?1:0; FLAG_NZ(r&0xFF); }
label_9C37:;
    /* $9C37: F0 */ nes_cpu_instruction_boundary(0x9C37, 2); if (g_cpu.Z) { maybe_trigger_vblank(1); goto label_9C43; }
label_9C39:;
    /* $9C39: A2 */ nes_cpu_instruction_boundary(0x9C39, 2); g_cpu.X = 0x50; FLAG_NZ(g_cpu.X);
label_9C3B:;
    /* $9C3B: DD */ nes_cpu_instruction_boundary(0x9C3B, 4); { uint8_t m=nes_read((0x6AF4 + g_cpu.X) & 0xFFFF); int r=g_cpu.A-m; g_cpu.C=(g_cpu.A>=m)?1:0; FLAG_NZ(r&0xFF); }
label_9C3E:;
    /* $9C3E: F0 */ nes_cpu_instruction_boundary(0x9C3E, 2); if (g_cpu.Z) { maybe_trigger_vblank(1); goto label_9C43; }
label_9C40:;
    /* $9C40: E6 */ nes_cpu_instruction_boundary(0x9C40, 5); { uint16_t a=0x7F; uint8_t v=(nes_read(a)+1)&0xFF; nes_write(a,v); FLAG_NZ(v); }
label_9C42:;
    /* $9C42: 60 */ nes_cpu_instruction_boundary(0x9C42, 6); { g_cpu.S++; uint8_t _rts_lo = g_ram[0x100 + g_cpu.S]; g_cpu.S++; uint8_t _rts_hi = g_ram[0x100 + g_cpu.S]; g_rts_target = (uint16_t)(((uint16_t)_rts_hi << 8) | _rts_lo); } /* pop JSR return address */

#ifdef RECOMP_STACK_TRACKING
    recomp_stack_pop();
#endif
    return;
label_9C43:; /* KraidTryToLaunchNail_BANK4_primeForLaunch */
    /* $9C43: A9 */ nes_cpu_instruction_boundary(0x9C43, 2); g_cpu.A = 0x08; FLAG_NZ(g_cpu.A);
label_9C45:;
    /* $9C45: 9D */ nes_cpu_instruction_boundary(0x9C45, 5); nes_write((0x0409 + g_cpu.X) & 0xFFFF, g_cpu.A);
label_9C48:; /* KraidTryToLaunchNail_BANK4_RTS */
    /* $9C48: 60 */ nes_cpu_instruction_boundary(0x9C48, 6); { g_cpu.S++; uint8_t _rts_lo = g_ram[0x100 + g_cpu.S]; g_cpu.S++; uint8_t _rts_hi = g_ram[0x100 + g_cpu.S]; g_rts_target = (uint16_t)(((uint16_t)_rts_hi << 8) | _rts_lo); } /* pop JSR return address */
...
label_802D:; /* CommonJump_EnemyGetDeltaY */
    /* $802D: 4C */ nes_cpu_instruction_boundary(0x802D, 3); nes_cpu_instruction_boundary(0x8244, 2); func_8244_b4(); return;
}
...
label_8030:; /* CommonJump_EnemyGetDeltaX */
    /* $8030: 4C */ nes_cpu_instruction_boundary(0x8030, 3); nes_cpu_instruction_boundary(0x8318, 2); func_8318_b4(); return;
}
...
#endif
label_9AE4:; /* KraidLintAIRoutine_BANK4 */
    /* $9AE4: BD */ nes_cpu_instruction_boundary(0x9AE4, 4); g_cpu.A = nes_read((0x0405 + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9AE7:;
    /* $9AE7: 29 */ nes_cpu_instruction_boundary(0x9AE7, 2); g_cpu.A &= 0x02; FLAG_NZ(g_cpu.A);
label_9AE9:;
    /* $9AE9: F0 */ nes_cpu_instruction_boundary(0x9AE9, 2); if (g_cpu.Z) { maybe_trigger_vblank(1); goto label_9AF2; }
label_9AEB:;
    /* $9AEB: BD */ nes_cpu_instruction_boundary(0x9AEB, 4); g_cpu.A = nes_read((0x6AF4 + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9AEE:;
    /* $9AEE: C9 */ nes_cpu_instruction_boundary(0x9AEE, 2); { int r=g_cpu.A-0x03; g_cpu.C=(g_cpu.A>=0x03)?1:0; FLAG_NZ(r&0xFF); }
label_9AF0:;
    /* $9AF0: D0 */ nes_cpu_instruction_boundary(0x9AF0, 2); if (!g_cpu.Z) { maybe_trigger_vblank(1); goto label_9AF9; }
label_9AF2:; /* KraidLintRemove_BANK4 */
    /* $9AF2: A9 */ nes_cpu_instruction_boundary(0x9AF2, 2); g_cpu.A = 0x00; FLAG_NZ(g_cpu.A);
label_9AF4:;
    /* $9AF4: 9D */ nes_cpu_instruction_boundary(0x9AF4, 5); nes_write((0x6AF4 + g_cpu.X) & 0xFFFF, g_cpu.A);
label_9AF7:;
    /* $9AF7: F0 */ nes_cpu_instruction_boundary(0x9AF7, 2); if (g_cpu.Z) { maybe_trigger_vblank(2); goto label_9B24; }
label_9AF9:; /* KraidLintMain_BANK4 */
    /* $9AF9: BD */ nes_cpu_instruction_boundary(0x9AF9, 4); g_cpu.A = nes_read((0x0405 + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9AFC:;
    /* $9AFC: 0A */ nes_cpu_instruction_boundary(0x9AFC, 2); g_cpu.C = (g_cpu.A>>7)&1; g_cpu.A = (g_cpu.A<<1)&0xFF; FLAG_NZ(g_cpu.A);
label_9AFD:;
    /* $9AFD: 30 */ nes_cpu_instruction_boundary(0x9AFD, 2); if (g_cpu.N) { maybe_trigger_vblank(2); goto label_9B24; }
label_9AFF:;
    /* $9AFF: BD */ nes_cpu_instruction_boundary(0x9AFF, 4); g_cpu.A = nes_read((0x6AF4 + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9B02:;
    /* $9B02: C9 */ nes_cpu_instruction_boundary(0x9B02, 2); { int r=g_cpu.A-0x02; g_cpu.C=(g_cpu.A>=0x02)?1:0; FLAG_NZ(r&0xFF); }
label_9B04:;
    /* $9B04: D0 */ nes_cpu_instruction_boundary(0x9B04, 2); if (!g_cpu.Z) { maybe_trigger_vblank(1); goto label_9B24; }
label_9B06:;
    /* $9B06: 20 */ nes_cpu_instruction_boundary(0x9B06, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x9B; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x08; g_cpu.S--; func_802D_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_9B09:;
    /* $9B09: A6 */ nes_cpu_instruction_boundary(0x9B09, 3); g_cpu.X = nes_read(0x4B); FLAG_NZ(g_cpu.X);
label_9B0B:;
    /* $9B0B: A5 */ nes_cpu_instruction_boundary(0x9B0B, 3); g_cpu.A = nes_read(0x00); FLAG_NZ(g_cpu.A);
label_9B0D:;
    /* $9B0D: 9D */ nes_cpu_instruction_boundary(0x9B0D, 5); nes_write((0x0402 + g_cpu.X) & 0xFFFF, g_cpu.A);
label_9B10:;
    /* $9B10: 20 */ nes_cpu_instruction_boundary(0x9B10, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x9B; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x12; g_cpu.S--; func_8030_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_9B13:;
    /* $9B13: A6 */ nes_cpu_instruction_boundary(0x9B13, 3); g_cpu.X = nes_read(0x4B); FLAG_NZ(g_cpu.X);
label_9B15:;
    /* $9B15: A5 */ nes_cpu_instruction_boundary(0x9B15, 3); g_cpu.A = nes_read(0x00); FLAG_NZ(g_cpu.A);
label_9B17:;
    /* $9B17: 9D */ nes_cpu_instruction_boundary(0x9B17, 5); nes_write((0x0403 + g_cpu.X) & 0xFFFF, g_cpu.A);
label_9B1A:;
    /* $9B1A: 20 */ nes_cpu_instruction_boundary(0x9B1A, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x9B; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x1C; g_cpu.S--; func_8033_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_9B1D:;
    /* $9B1D: B0 */ nes_cpu_instruction_boundary(0x9B1D, 2); if (g_cpu.C) { maybe_trigger_vblank(1); goto label_9B24; }
label_9B1F:;
    /* $9B1F: A9 */ nes_cpu_instruction_boundary(0x9B1F, 2); g_cpu.A = 0x03; FLAG_NZ(g_cpu.A);
label_9B21:;
    /* $9B21: 9D */ nes_cpu_instruction_boundary(0x9B21, 5); nes_write((0x6AF4 + g_cpu.X) & 0xFFFF, g_cpu.A);
label_9B24:; /* KraidLintDraw_BANK4 */
    /* $9B24: A9 */ nes_cpu_instruction_boundary(0x9B24, 2); g_cpu.A = 0x01; FLAG_NZ(g_cpu.A);
label_9B26:;
    /* $9B26: 20 */ nes_cpu_instruction_boundary(0x9B26, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x9B; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x28; g_cpu.S--; func_800C_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_9B29:;
    /* $9B29: 4C */ nes_cpu_instruction_boundary(0x9B29, 3); nes_cpu_instruction_boundary(0x8006, 2); func_8006_b4(); return;
}

void func_9B3C_b4_body(int _entry) { /* KraidUpdateProjectile_BANK4 */
    switch (_entry) {
        case 1: goto label_9BAA;
    }
label_9B3C:; /* KraidUpdateProjectile_BANK4 */
    /* $9B3C: BC */ nes_cpu_instruction_boundary(0x9B3C, 4); g_cpu.Y = nes_read((0x6AF4 + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.Y);
label_9B3F:;
    /* $9B3F: F0 */ nes_cpu_instruction_boundary(0x9B3F, 2); if (g_cpu.Z) { maybe_trigger_vblank(1); goto label_9B67; }
label_9B41:;
    /* $9B41: BD */ nes_cpu_instruction_boundary(0x9B41, 4); g_cpu.A = nes_read((0x6B02 + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9B44:;
    /* $9B44: C9 */ nes_cpu_instruction_boundary(0x9B44, 2); { int r=g_cpu.A-0x0A; g_cpu.C=(g_cpu.A>=0x0A)?1:0; FLAG_NZ(r&0xFF); }
label_9B46:;
    /* $9B46: F0 */ nes_cpu_instruction_boundary(0x9B46, 2); if (g_cpu.Z) { maybe_trigger_vblank(1); goto label_9B4C; }
label_9B48:;
    /* $9B48: C9 */ nes_cpu_instruction_boundary(0x9B48, 2); { int r=g_cpu.A-0x09; g_cpu.C=(g_cpu.A>=0x09)?1:0; FLAG_NZ(r&0xFF); }
label_9B4A:;
    /* $9B4A: D0 */ nes_cpu_instruction_boundary(0x9B4A, 2); if (!g_cpu.Z) { maybe_trigger_vblank(1); goto label_9BBB; }
label_9B4C:; /* KraidUpdateProjectile_BANK4_branchA */
    /* $9B4C: BD */ nes_cpu_instruction_boundary(0x9B4C, 4); g_cpu.A = nes_read((0x0405 + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9B4F:;
    /* $9B4F: 29 */ nes_cpu_instruction_boundary(0x9B4F, 2); g_cpu.A &= 0x02; FLAG_NZ(g_cpu.A);
label_9B51:;
    /* $9B51: F0 */ nes_cpu_instruction_boundary(0x9B51, 2); if (g_cpu.Z) { maybe_trigger_vblank(1); goto label_9B67; }
label_9B53:;
    /* $9B53: 88 */ nes_cpu_instruction_boundary(0x9B53, 2); g_cpu.Y = (g_cpu.Y-1)&0xFF; FLAG_NZ(g_cpu.Y);
label_9B54:;
    /* $9B54: F0 */ nes_cpu_instruction_boundary(0x9B54, 2); if (g_cpu.Z) { maybe_trigger_vblank(1); goto label_9B72; }
label_9B56:;
    /* $9B56: C0 */ nes_cpu_instruction_boundary(0x9B56, 2); { int r=g_cpu.Y-0x02; g_cpu.C=(g_cpu.Y>=0x02)?1:0; FLAG_NZ(r&0xFF); }
label_9B58:;
    /* $9B58: F0 */ nes_cpu_instruction_boundary(0x9B58, 2); if (g_cpu.Z) { maybe_trigger_vblank(1); goto label_9B67; }
label_9B5A:;
    /* $9B5A: C0 */ nes_cpu_instruction_boundary(0x9B5A, 2); { int r=g_cpu.Y-0x03; g_cpu.C=(g_cpu.Y>=0x03)?1:0; FLAG_NZ(r&0xFF); }
label_9B5C:;
    /* $9B5C: D0 */ nes_cpu_instruction_boundary(0x9B5C, 2); if (!g_cpu.Z) { maybe_trigger_vblank(1); goto label_9BBB; }
label_9B5E:;
    /* $9B5E: BD */ nes_cpu_instruction_boundary(0x9B5E, 4); g_cpu.A = nes_read((0x040C + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9B61:;
    /* $9B61: C9 */ nes_cpu_instruction_boundary(0x9B61, 2); { int r=g_cpu.A-0x01; g_cpu.C=(g_cpu.A>=0x01)?1:0; FLAG_NZ(r&0xFF); }
label_9B63:;
    /* $9B63: D0 */ nes_cpu_instruction_boundary(0x9B63, 2); if (!g_cpu.Z) { maybe_trigger_vblank(1); goto label_9BBB; }
label_9B65:;
    /* $9B65: F0 */ nes_cpu_instruction_boundary(0x9B65, 2); if (g_cpu.Z) { maybe_trigger_vblank(1); goto label_9B72; }
label_9B67:; /* KraidUpdateProjectile_BANK4_remove */
    /* $9B67: A9 */ nes_cpu_instruction_boundary(0x9B67, 2); g_cpu.A = 0x00; FLAG_NZ(g_cpu.A);
label_9B69:;
    /* $9B69: 9D */ nes_cpu_instruction_boundary(0x9B69, 5); nes_write((0x6AF4 + g_cpu.X) & 0xFFFF, g_cpu.A);
label_9B6C:;
    /* $9B6C: 9D */ nes_cpu_instruction_boundary(0x9B6C, 5); nes_write((0x040F + g_cpu.X) & 0xFFFF, g_cpu.A);
label_9B6F:;
    /* $9B6F: 20 */ nes_cpu_instruction_boundary(0x9B6F, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x9B; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x71; g_cpu.S--; func_802A_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
#endif
    return; } }
label_9B72:; /* KraidUpdateProjectile_BANK4_resting */
    /* $9B72: AD */ nes_cpu_instruction_boundary(0x9B72, 4); g_cpu.A = nes_read(0x0405); FLAG_NZ(g_cpu.A);
label_9B75:;
    /* $9B75: 9D */ nes_cpu_instruction_boundary(0x9B75, 5); nes_write((0x0405 + g_cpu.X) & 0xFFFF, g_cpu.A);
label_9B78:;
    /* $9B78: 4A */ nes_cpu_instruction_boundary(0x9B78, 2); g_cpu.C = g_cpu.A&1; g_cpu.A >>= 1; FLAG_NZ(g_cpu.A);
label_9B79:;
    /* $9B79: 08 */ nes_cpu_instruction_boundary(0x9B79, 3); { uint8_t p = (g_cpu.N<<7)|(g_cpu.V<<6)|0x30|(g_cpu.D<<3)|(g_cpu.I<<2)|(g_cpu.Z<<1)|g_cpu.C;
  g_ram[0x100 + g_cpu.S] = p; g_cpu.S--; }
label_9B7A:;
    /* $9B7A: 8A */ nes_cpu_instruction_boundary(0x9B7A, 2); g_cpu.A = g_cpu.X; FLAG_NZ(g_cpu.A);
label_9B7B:;
    /* $9B7B: 4A */ nes_cpu_instruction_boundary(0x9B7B, 2); g_cpu.C = g_cpu.A&1; g_cpu.A >>= 1; FLAG_NZ(g_cpu.A);
label_9B7C:;
    /* $9B7C: 4A */ nes_cpu_instruction_boundary(0x9B7C, 2); g_cpu.C = g_cpu.A&1; g_cpu.A >>= 1; FLAG_NZ(g_cpu.A);
label_9B7D:;
    /* $9B7D: 4A */ nes_cpu_instruction_boundary(0x9B7D, 2); g_cpu.C = g_cpu.A&1; g_cpu.A >>= 1; FLAG_NZ(g_cpu.A);
label_9B7E:;
    /* $9B7E: 4A */ nes_cpu_instruction_boundary(0x9B7E, 2); g_cpu.C = g_cpu.A&1; g_cpu.A >>= 1; FLAG_NZ(g_cpu.A);
label_9B7F:;
    /* $9B7F: A8 */ nes_cpu_instruction_boundary(0x9B7F, 2); g_cpu.Y = g_cpu.A; FLAG_NZ(g_cpu.Y);
label_9B80:;
    /* $9B80: B9 */ nes_cpu_instruction_boundary(0x9B80, 4); g_cpu.A = nes_read((0x9BCB + g_cpu.Y) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9B83:;
    /* $9B83: 85 */ nes_cpu_instruction_boundary(0x9B83, 3); nes_write(0x04, g_cpu.A);
label_9B85:;
    /* $9B85: B9 */ nes_cpu_instruction_boundary(0x9B85, 4); g_cpu.A = nes_read((0x9BDA + g_cpu.Y) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9B88:;
    /* $9B88: 9D */ nes_cpu_instruction_boundary(0x9B88, 5); nes_write((0x6B02 + g_cpu.X) & 0xFFFF, g_cpu.A);
label_9B8B:;
    /* $9B8B: 98 */ nes_cpu_instruction_boundary(0x9B8B, 2); g_cpu.A = g_cpu.Y; FLAG_NZ(g_cpu.A);
label_9B8C:;
    /* $9B8C: 28 */ nes_cpu_instruction_boundary(0x9B8C, 4); { g_cpu.S++; uint8_t p = g_ram[0x100 + g_cpu.S];
  g_cpu.N=(p>>7)&1; g_cpu.V=(p>>6)&1; g_cpu.D=(p>>3)&1;
  g_cpu.I=(p>>2)&1; g_cpu.Z=(p>>1)&1; g_cpu.C=p&1; }
label_9B8D:;
    /* $9B8D: 2A */ nes_cpu_instruction_boundary(0x9B8D, 2); { uint8_t c=g_cpu.C; g_cpu.C=(g_cpu.A>>7)&1; g_cpu.A=((g_cpu.A<<1)|c)&0xFF; FLAG_NZ(g_cpu.A); }
label_9B8E:;
    /* $9B8E: A8 */ nes_cpu_instruction_boundary(0x9B8E, 2); g_cpu.Y = g_cpu.A; FLAG_NZ(g_cpu.Y);
label_9B8F:;
    /* $9B8F: B9 */ nes_cpu_instruction_boundary(0x9B8F, 4); g_cpu.A = nes_read((0x9BCF + g_cpu.Y) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9B92:;
    /* $9B92: 85 */ nes_cpu_instruction_boundary(0x9B92, 3); nes_write(0x05, g_cpu.A);
label_9B94:;
    /* $9B94: 8A */ nes_cpu_instruction_boundary(0x9B94, 2); g_cpu.A = g_cpu.X; FLAG_NZ(g_cpu.A);
label_9B95:;
    /* $9B95: 48 */ nes_cpu_instruction_boundary(0x9B95, 3); g_ram[0x100 + g_cpu.S] = g_cpu.A; g_cpu.S--;
label_9B96:;
    /* $9B96: A2 */ nes_cpu_instruction_boundary(0x9B96, 2); g_cpu.X = 0x00; FLAG_NZ(g_cpu.X);
label_9B98:;
    /* $9B98: 20 */ nes_cpu_instruction_boundary(0x9B98, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x9B; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x9A; g_cpu.S--; func_9BBC_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_9B9B:;
    /* $9B9B: 68 */ nes_cpu_instruction_boundary(0x9B9B, 4); g_cpu.S++; g_cpu.A = g_ram[0x100 + g_cpu.S]; FLAG_NZ(g_cpu.A);
label_9B9C:;
    /* $9B9C: AA */ nes_cpu_instruction_boundary(0x9B9C, 2); g_cpu.X = g_cpu.A; FLAG_NZ(g_cpu.X);
label_9B9D:;
    /* $9B9D: 20 */ nes_cpu_instruction_boundary(0x9B9D, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x9B; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x9F; g_cpu.S--; func_8027_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_9BA0:;
    /* $9BA0: 90 */ nes_cpu_instruction_boundary(0x9BA0, 2); if (!g_cpu.C) { maybe_trigger_vblank(1); goto label_9BBB; }
label_9BA2:;
    /* $9BA2: BD */ nes_cpu_instruction_boundary(0x9BA2, 4); g_cpu.A = nes_read((0x6AF4 + g_cpu.X) & 0xFFFF); FLAG_NZ(g_cpu.A);
label_9BA5:;
    /* $9BA5: D0 */ nes_cpu_instruction_boundary(0x9BA5, 2); if (!g_cpu.Z) { maybe_trigger_vblank(1); goto label_9BAA; }
label_9BA7:;
    /* $9BA7: FE */ nes_cpu_instruction_boundary(0x9BA7, 7); { uint16_t a=(0x6AF4 + g_cpu.X) & 0xFFFF; uint8_t v=(nes_read(a)+1)&0xFF; nes_write(a,v); FLAG_NZ(v); }
label_9BAA:; /* LoadEnemyPositionFromTemp__BANK4 */
    /* $9BAA: A5 */ nes_cpu_instruction_boundary(0x9BAA, 3); g_cpu.A = nes_read(0x08); FLAG_NZ(g_cpu.A);
label_9BAC:;
    /* $9BAC: 9D */ nes_cpu_instruction_boundary(0x9BAC, 5); nes_write((0x0400 + g_cpu.X) & 0xFFFF, g_cpu.A);
label_9BAF:;
    /* $9BAF: A5 */ nes_cpu_instruction_boundary(0x9BAF, 3); g_cpu.A = nes_read(0x09); FLAG_NZ(g_cpu.A);
label_9BB1:;
    /* $9BB1: 9D */ nes_cpu_instruction_boundary(0x9BB1, 5); nes_write((0x0401 + g_cpu.X) & 0xFFFF, g_cpu.A);
label_9BB4:;
    /* $9BB4: A5 */ nes_cpu_instruction_boundary(0x9BB4, 3); g_cpu.A = nes_read(0x0B); FLAG_NZ(g_cpu.A);
label_9BB6:;
    /* $9BB6: 29 */ nes_cpu_instruction_boundary(0x9BB6, 2); g_cpu.A &= 0x01; FLAG_NZ(g_cpu.A);
label_9BB8:;
    /* $9BB8: 9D */ nes_cpu_instruction_boundary(0x9BB8, 5); nes_write((0x6AFB + g_cpu.X) & 0xFFFF, g_cpu.A);
label_9BBB:; /* KraidUpdateProjectile_Exit_BANK4 */
    /* $9BBB: 60 */ nes_cpu_instruction_boundary(0x9BBB, 6); { g_cpu.S++; uint8_t _rts_lo = g_ram[0x100 + g_cpu.S]; g_cpu.S++; uint8_t _rts_hi = g_ram[0x100 + g_cpu.S]; g_rts_target = (uint16_t)(((uint16_t)_rts_hi << 8) | _rts_lo); } /* pop JSR return address */
...
#ifdef RECOMP_STACK_TRACKING
    recomp_stack_push("func_9E69_b4");
#endif
label_9E69:;
    /* $9E69: F8 */ nes_cpu_instruction_boundary(0x9E69, 2); g_cpu.D = 1;
label_9E6A:;
    /* $9E6A: 04 */ nes_cpu_instruction_boundary(0x9E6A, 3); (void)nes_read(0x00); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9E6C:;
    /* $9E6C: F4 */ nes_cpu_instruction_boundary(0x9E6C, 4); (void)nes_read((0x00 + g_cpu.X) & 0xFF); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9E6E:;
    /* $9E6E: FC */ nes_cpu_instruction_boundary(0x9E6E, 4); (void)nes_read((0x0400 + g_cpu.X) & 0xFFFF); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9E71:;
    /* $9E71: 08 */ nes_cpu_instruction_boundary(0x9E71, 3); { uint8_t p = (g_cpu.N<<7)|(g_cpu.V<<6)|0x30|(g_cpu.D<<3)|(g_cpu.I<<2)|(g_cpu.Z<<1)|g_cpu.C;
  g_ram[0x100 + g_cpu.S] = p; g_cpu.S--; }
label_9E72:;
    /* $9E72: F4 */ nes_cpu_instruction_boundary(0x9E72, 4); (void)nes_read((0x08 + g_cpu.X) & 0xFF); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9E74:;
    /* $9E74: FC */ nes_cpu_instruction_boundary(0x9E74, 4); (void)nes_read((0x0408 + g_cpu.X) & 0xFFFF); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9E77:; /* EnPlace3_BANK4 */
    /* $9E77: F8 */ nes_cpu_instruction_boundary(0x9E77, 2); g_cpu.D = 1;
label_9E78:;
    /* $9E78: F4 */ nes_cpu_instruction_boundary(0x9E78, 4); (void)nes_read((0x00 + g_cpu.X) & 0xFF); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9E7A:;
    /* $9E7A: F4 */ nes_cpu_instruction_boundary(0x9E7A, 4); (void)nes_read((0xF8 + g_cpu.X) & 0xFF); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9E7C:;
    /* $9E7C: FC */ nes_cpu_instruction_boundary(0x9E7C, 4); (void)nes_read((0xFC00 + g_cpu.X) & 0xFFFF); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9E7F:;
    /* $9E7F: F4 */ nes_cpu_instruction_boundary(0x9E7F, 4); (void)nes_read((0xFC + g_cpu.X) & 0xFF); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9E81:;
    /* $9E81: FC */ nes_cpu_instruction_boundary(0x9E81, 4); (void)nes_read((0xF8FC + g_cpu.X) & 0xFFFF); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9E84:;
    /* $9E84: 04 */ nes_cpu_instruction_boundary(0x9E84, 3); (void)nes_read(0x00); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9E86:;
    /* $9E86: 04 */ nes_cpu_instruction_boundary(0x9E86, 3); (void)nes_read(0x02); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9E88:;
    /* $9E88: F4 */ nes_cpu_instruction_boundary(0x9E88, 4); (void)nes_read((0x0A + g_cpu.X) & 0xFF); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9E8A:;
    /* $9E8A: F4 */ nes_cpu_instruction_boundary(0x9E8A, 4); (void)nes_read((0xF8 + g_cpu.X) & 0xFF); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9E8C:;
    /* $9E8C: FC */ nes_cpu_instruction_boundary(0x9E8C, 4); (void)nes_read((0xFC00 + g_cpu.X) & 0xFFFF); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9E8F:;
    /* $9E8F: 02 */ nes_cpu_instruction_boundary(0x9E8F, 2); /* ILLEGAL $02 — skip 1 */
label_9E90:;
    /* $9E90: 04 */ nes_cpu_instruction_boundary(0x9E90, 3); (void)nes_read(0x0A); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9E92:;
    /* $9E92: 04 */ nes_cpu_instruction_boundary(0x9E92, 3); (void)nes_read(0xF8); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_9E94:;
    /* $9E94: F8 */ nes_cpu_instruction_boundary(0x9E94, 2); g_cpu.D = 1;
label_9E95:;
    /* $9E95: F8 */ nes_cpu_instruction_boundary(0x9E95, 2); g_cpu.D = 1;
label_9E96:;
    /* $9E96: 00 */ nes_cpu_instruction_boundary(0x9E96, 7); nes_brk_executed(0x9E96); return;
}
...
label_8067:;
    /* $8067: 20 */ nes_cpu_instruction_boundary(0x8067, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x80; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x69; g_cpu.S--; func_8244_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8073:; /* EnemyMove_loop_Up */
    /* $8073: 20 */ nes_cpu_instruction_boundary(0x8073, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x80; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x75; g_cpu.S--; func_83F5_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_8076:;
    /* $8076: 20 */ nes_cpu_instruction_boundary(0x8076, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x80; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x78; g_cpu.S--; func_80B8_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8081:; /* EnemyMove_loop_Down */
    /* $8081: 20 */ nes_cpu_instruction_boundary(0x8081, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x80; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x83; g_cpu.S--; func_844B_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_8084:;
    /* $8084: 20 */ nes_cpu_instruction_boundary(0x8084, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x80; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x86; g_cpu.S--; func_80FB_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_808B:; /* EnemyMove_endIf_Down */
    /* $808B: 20 */ nes_cpu_instruction_boundary(0x808B, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x80; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x8D; g_cpu.S--; func_8318_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8097:; /* EnemyMove_loop_Left */
    /* $8097: 20 */ nes_cpu_instruction_boundary(0x8097, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x80; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x99; g_cpu.S--; func_84A7_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_809A:;
    /* $809A: 20 */ nes_cpu_instruction_boundary(0x809A, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x80; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x9C; g_cpu.S--; func_816E_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_80A5:; /* EnemyMove_loop_Right */
    /* $80A5: 20 */ nes_cpu_instruction_boundary(0x80A5, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x80; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xA7; g_cpu.S--; func_84FE_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_80A8:;
    /* $80A8: 20 */ nes_cpu_instruction_boundary(0x80A8, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x80; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xAA; g_cpu.S--; func_8134_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B3C2:;
    /* $B3C2: 20 */ nes_cpu_instruction_boundary(0xB3C2, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB3; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xC4; g_cpu.S--; func_B46E_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
void func_B4ED_b4_body(int _entry) { /* GetSoundRoutine */
    switch (_entry) {
...
void func_8244_b4_body(int _entry) { /* EnemyGetDeltaY */
    switch (_entry) {
        case 1: goto label_82C3;
        case 2: goto label_825B;
        case 3: goto label_82F4;
        case 4: goto label_8258;
        case 5: goto label_82A2;
        case 6: goto label_8296;
    }
label_8244:; /* EnemyGetDeltaY */
    /* $8244: 20 */ nes_cpu_instruction_boundary(0x8244, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x82; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x46; g_cpu.S--; func_80B0_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8249:;
    /* $8249: 4C */ nes_cpu_instruction_boundary(0x8249, 3); nes_cpu_instruction_boundary(0x833F, 2); func_833F_b4(); return;
...
label_8255:;
    /* $8255: 20 */ nes_cpu_instruction_boundary(0x8255, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x82; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x57; g_cpu.S--; func_822B_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_827C:; /* GotoEnemyGetDeltaY_TriggerResting */
    /* $827C: 4C */ nes_cpu_instruction_boundary(0x827C, 3); nes_cpu_instruction_boundary(0x8312, 2); func_8312_b4(); return;
...
if (g_cpu.S != _cbs) {
    ...
    return; } }
label_82BB:;
    /* $82BB: 4C */ nes_cpu_instruction_boundary(0x82BB, 3); nes_cpu_instruction_boundary(0x82C3, 2); func_82C3_b4(); return;
...
if (g_cpu.S != _cbs) {
    ...
    return; } }
label_82EC:;
    /* $82EC: 4C */ nes_cpu_instruction_boundary(0x82EC, 3); nes_cpu_instruction_boundary(0x82F4, 2); func_82F4_b4(); return;
...
label_8312:; /* EnemyGetDeltaY_RepeatPreviousUntilNoDeltaYThenTriggerResting_endIf_B */
    /* $8312: 20 */ nes_cpu_instruction_boundary(0x8312, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x83; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x14; g_cpu.S--; func_81B1_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
void func_8318_b4_body(int _entry) { /* EnemyGetDeltaX */
    switch (_entry) {
        case 1: goto label_832F;
    }
label_8318:; /* EnemyGetDeltaX */
    /* $8318: 20 */ nes_cpu_instruction_boundary(0x8318, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x83; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x1A; g_cpu.S--; func_80B0_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_831D:;
    /* $831D: 4C */ nes_cpu_instruction_boundary(0x831D, 3); nes_cpu_instruction_boundary(0x8395, 2); func_8395_b4(); return;
...
#ifdef RECOMP_STACK_TRACKING
    recomp_stack_push("func_AD04_b4");
#endif
label_AD04:;
...
#ifdef RECOMP_STACK_TRACKING
    recomp_stack_push("func_ADFC_b4");
#endif
label_ADFC:;
...
label_AEC8:;
    /* $AEC8: 40 */ nes_cpu_instruction_boundary(0xAEC8, 6); /* RTI */ g_rti_source = 0xAEC8; g_rti_bank = 4; g_cpu.S++; { uint8_t p=g_ram[0x100+g_cpu.S]; g_cpu.N=(p>>7)&1; g_cpu.V=(p>>6)&1; g_cpu.D=(p>>3)&1; g_cpu.I=(p>>2)&1; g_cpu.Z=(p>>1)&1; g_cpu.C=p&1; }
...
#endif
label_BB22:;
    /* $BB22: 4C */ nes_cpu_instruction_boundary(0xBB22, 3); nes_cpu_instruction_boundary(0xBDBB, 2); func_BDBB_b4(); return;
}
...
label_B92C:;
    /* $B92C: 20 */ nes_cpu_instruction_boundary(0xB92C, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB9; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x2E; g_cpu.S--; func_B9BC_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B939:;
    /* $B939: 4C */ nes_cpu_instruction_boundary(0xB939, 3); nes_cpu_instruction_boundary(0xB8C6, 2); func_B8C6_b4(); return;
label_B93C:;
    /* $B93C: 20 */ nes_cpu_instruction_boundary(0xB93C, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB9; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x3E; g_cpu.S--; func_B9D0_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B94B:;
    /* $B94B: 20 */ nes_cpu_instruction_boundary(0xB94B, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB9; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x4D; g_cpu.S--; func_B9A8_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_B94E:;
    /* $B94E: 4C */ nes_cpu_instruction_boundary(0xB94E, 3); nes_cpu_instruction_boundary(0xB899, 2); func_B899_b4(); return;
}
...
void func_B482_b4_body(int _entry) { /* InitSFXData */
    switch (_entry) {
...
label_B498:; /* InitSFXData_SQ1 */
    /* $B498: 20 */ nes_cpu_instruction_boundary(0xB498, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB4; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x9A; g_cpu.S--; func_B398_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B49D:; /* InitSFXData_SQ2 */
    /* $B49D: 20 */ nes_cpu_instruction_boundary(0xB49D, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB4; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x9F; g_cpu.S--; func_B3A4_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B4A2:; /* InitSFXData_Tri */
    /* $B4A2: 20 */ nes_cpu_instruction_boundary(0xB4A2, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB4; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xA4; g_cpu.S--; func_B39C_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B4A7:; /* InitSFXData_Noise */
    /* $B4A7: 20 */ nes_cpu_instruction_boundary(0xB4A7, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB4; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xA9; g_cpu.S--; func_B3A0_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B4AA:; /* InitSFXData_Common */
    /* $B4AA: 20 */ nes_cpu_instruction_boundary(0xB4AA, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB4; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xAC; g_cpu.S--; func_B4C3_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B5BF:; /* EndNoiseSFX */
    /* $B5BF: 20 */ nes_cpu_instruction_boundary(0xB5BF, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB5; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xC1; g_cpu.S--; func_B4D2_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B5B7:; /* GotoInitSFXData */
    /* $B5B7: 4C */ nes_cpu_instruction_boundary(0xB5B7, 3); nes_cpu_instruction_boundary(0xB482, 2); func_B482_b4(); return;
}
...
label_B5D8:;
    /* $B5D8: 20 */ nes_cpu_instruction_boundary(0xB5D8, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB5; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xDA; g_cpu.S--; func_B3A4_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_B5DB:;
    /* $B5DB: 20 */ nes_cpu_instruction_boundary(0xB5DB, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB5; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xDD; g_cpu.S--; func_B4C3_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B60D:;
    /* $B60D: 20 */ nes_cpu_instruction_boundary(0xB60D, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB6; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x0F; g_cpu.S--; func_B4D2_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B72C:;
    /* $B72C: 20 */ nes_cpu_instruction_boundary(0xB72C, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB7; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x2E; g_cpu.S--; func_B4D2_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
void func_B8C6_b4_body(int _entry) { /* EndTriSFX */
    switch (_entry) {
...
label_B8D3:;
    /* $B8D3: 20 */ nes_cpu_instruction_boundary(0xB8D3, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB8; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xD5; g_cpu.S--; func_B4D2_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_95C3:; /* AreaRoutine */
    /* $95C3: 4C */ nes_cpu_instruction_boundary(0x95C3, 3); nes_cpu_instruction_boundary(0x9C49, 2); func_9C49_b4(); return;
}

void func_8B13_b4_body(int _entry) { /* SamusEnterDoor */
    switch (_entry) {
...
label_8B56:;
    /* $8B56: 20 */ nes_cpu_instruction_boundary(0x8B56, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x8B; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x58; g_cpu.S--; func_8B74_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8B6C:; /* SetDoorEntryInfo_RTS */
    ...
    return;
label_8B6D:;
    /* $8B6D: 20 */ nes_cpu_instruction_boundary(0x8B6D, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x8B; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x6F; g_cpu.S--; func_8B53_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8B7B:; /* UpdateAllDoors_loop */
    /* $8B7B: 20 */ nes_cpu_instruction_boundary(0x8B7B, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x8B; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x7D; g_cpu.S--; func_8B87_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
void func_83F5_b4_body(int _entry) { /* EnemyMoveOnePixelUp */
    switch (_entry) {
...
label_8421:;
    /* $8421: 20 */ nes_cpu_instruction_boundary(0x8421, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x84; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x23; g_cpu.S--; func_8563_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8426:;
    /* $8426: 20 */ nes_cpu_instruction_boundary(0x8426, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x84; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x28; g_cpu.S--; func_855A_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8437:;
    /* $8437: 20 */ nes_cpu_instruction_boundary(0x8437, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x84; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x39; g_cpu.S--; func_8563_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
void func_80B8_b4_body(int _entry) { /* EnemyIfMoveFailedUp */
    switch (_entry) {
...
label_80C1:; /* EnemyIfMoveFailedUp_bounce */
    /* $80C1: 20 */ nes_cpu_instruction_boundary(0x80C1, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x80; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xC3; g_cpu.S--; func_81FC_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_80C4:;
    /* $80C4: 4C */ nes_cpu_instruction_boundary(0x80C4, 3); nes_cpu_instruction_boundary(0x80F6, 2); func_80F6_b4(); return;
label_80C7:; /* EnemyIfMoveFailedUp_facingHorizontal */
    /* $80C7: 20 */ nes_cpu_instruction_boundary(0x80C7, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x80; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xC9; g_cpu.S--; func_80B0_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_80D3:;
    /* $80D3: 20 */ nes_cpu_instruction_boundary(0x80D3, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x80; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xD5; g_cpu.S--; func_81B1_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_80DF:;
    /* $80DF: 4C */ nes_cpu_instruction_boundary(0x80DF, 3); nes_cpu_instruction_boundary(0x80F6, 2); func_80F6_b4(); return;
...
label_80F3:;
    /* $80F3: 20 */ nes_cpu_instruction_boundary(0x80F3, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x80; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xF5; g_cpu.S--; func_856B_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8479:;
    /* $8479: 20 */ nes_cpu_instruction_boundary(0x8479, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x84; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x7B; g_cpu.S--; func_8563_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_847E:;
    /* $847E: 20 */ nes_cpu_instruction_boundary(0x847E, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x84; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x80; g_cpu.S--; func_855A_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8492:;
    /* $8492: 20 */ nes_cpu_instruction_boundary(0x8492, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x84; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x94; g_cpu.S--; func_8563_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
void func_80FB_b4_body(int _entry) { /* EnemyIfMoveFailedDown */
    switch (_entry) {
...
label_8104:; /* EnemyIfMoveFailedDown_bounce */
    /* $8104: 20 */ nes_cpu_instruction_boundary(0x8104, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x06; g_cpu.S--; func_81FC_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_8107:;
    /* $8107: 4C */ nes_cpu_instruction_boundary(0x8107, 3); nes_cpu_instruction_boundary(0x812F, 2); func_812F_b4(); return;
label_810A:; /* EnemyIfMoveFailedDown_facingHorizontal */
    /* $810A: 20 */ nes_cpu_instruction_boundary(0x810A, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x0C; g_cpu.S--; func_80B0_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_811D:;
    /* $811D: 4C */ nes_cpu_instruction_boundary(0x811D, 3); nes_cpu_instruction_boundary(0x812F, 2); func_812F_b4(); return;
label_8120:; /* EnemyIfMoveFailedDown_landOnFloor */
    /* $8120: 20 */ nes_cpu_instruction_boundary(0x8120, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x22; g_cpu.S--; func_81B1_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_812C:;
    /* $812C: 20 */ nes_cpu_instruction_boundary(0x812C, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x2E; g_cpu.S--; func_856B_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
void func_84A7_b4_body(int _entry) { /* EnemyMoveOnePixelLeft */
    switch (_entry) {
...
label_84D1:;
    /* $84D1: 20 */ nes_cpu_instruction_boundary(0x84D1, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x84; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xD3; g_cpu.S--; func_8563_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_84D7:;
    /* $84D7: 20 */ nes_cpu_instruction_boundary(0x84D7, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x84; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xD9; g_cpu.S--; func_855A_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_84E9:;
    /* $84E9: 20 */ nes_cpu_instruction_boundary(0x84E9, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x84; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xEB; g_cpu.S--; func_8563_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
void func_816E_b4_body(int _entry) { /* EnemyIfMoveFailedLeft */
    switch (_entry) {
...
label_8172:;
    /* $8172: 20 */ nes_cpu_instruction_boundary(0x8172, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x74; g_cpu.S--; func_80B0_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_817C:; /* EnemyIfMoveFailedLeft_bounce */
    /* $817C: 20 */ nes_cpu_instruction_boundary(0x817C, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x7E; g_cpu.S--; func_81C7_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_817F:;
    /* $817F: 4C */ nes_cpu_instruction_boundary(0x817F, 3); nes_cpu_instruction_boundary(0x81AC, 2); func_81AC_b4(); return;
...
label_8189:;
    /* $8189: 20 */ nes_cpu_instruction_boundary(0x8189, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x8B; g_cpu.S--; func_81C0_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8195:;
    /* $8195: 4C */ nes_cpu_instruction_boundary(0x8195, 3); nes_cpu_instruction_boundary(0x81AC, 2); func_81AC_b4(); return;
...
label_81A0:; /* EnemyIfMoveFailedLeft_movementStrings */
    /* $81A0: 20 */ nes_cpu_instruction_boundary(0x81A0, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xA2; g_cpu.S--; func_80B0_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_81A9:;
    /* $81A9: 20 */ nes_cpu_instruction_boundary(0x81A9, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xAB; g_cpu.S--; func_856B_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
void func_84FE_b4_body(int _entry) { /* EnemyMoveOnePixelRight */
    switch (_entry) {
...
label_8528:;
    /* $8528: 20 */ nes_cpu_instruction_boundary(0x8528, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x85; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x2A; g_cpu.S--; func_8563_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8533:; /* EnemyMoveOnePixelRight_endIf_C */
    /* $8533: 20 */ nes_cpu_instruction_boundary(0x8533, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x85; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x35; g_cpu.S--; func_855A_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8545:;
    /* $8545: 20 */ nes_cpu_instruction_boundary(0x8545, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x85; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x47; g_cpu.S--; func_8563_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
void func_8134_b4_body(int _entry) { /* EnemyIfMoveFailedRight */
    switch (_entry) {
...
label_8138:;
    /* $8138: 20 */ nes_cpu_instruction_boundary(0x8138, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x3A; g_cpu.S--; func_80B0_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8142:; /* EnemyIfMoveFailedRight_bounce */
    /* $8142: 20 */ nes_cpu_instruction_boundary(0x8142, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x44; g_cpu.S--; func_81C7_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_8145:;
    /* $8145: 4C */ nes_cpu_instruction_boundary(0x8145, 3); nes_cpu_instruction_boundary(0x8169, 2); func_8169_b4(); return;
...
label_8156:;
    /* $8156: 4C */ nes_cpu_instruction_boundary(0x8156, 3); nes_cpu_instruction_boundary(0x8169, 2); func_8169_b4(); return;
label_8159:; /* EnemyIfMoveFailedRight_landOnRightWall */
    /* $8159: 20 */ nes_cpu_instruction_boundary(0x8159, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x5B; g_cpu.S--; func_81C0_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8166:;
    /* $8166: 20 */ nes_cpu_instruction_boundary(0x8166, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x68; g_cpu.S--; func_856B_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
if (g_cpu.S != _cbs) {
    ...
    return; } }
label_8315:;
    /* $8315: 4C */ nes_cpu_instruction_boundary(0x8315, 3); nes_cpu_instruction_boundary(0x82A2, 2); func_82A2_b4(); return;
}
...
label_81B1:; /* EnemyTriggerResting_AndClearEnAccelY */
    /* $81B1: 20 */ nes_cpu_instruction_boundary(0x81B1, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xB3; g_cpu.S--; func_81B8_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_BA78:;
    /* $BA78: 20 */ nes_cpu_instruction_boundary(0xBA78, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xBA; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x7A; g_cpu.S--; func_BA38_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_BACD:; /* GotoEndOrLoopMusic */
    /* $BACD: 20 */ nes_cpu_instruction_boundary(0xBACD, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xBA; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xCF; g_cpu.S--; func_B420_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_BA69:;
    /* $BA69: 20 */ nes_cpu_instruction_boundary(0xBA69, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xBA; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x6B; g_cpu.S--; func_BA71_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_BA6D:;
    /* $BA6D: 20 */ nes_cpu_instruction_boundary(0xBA6D, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xBA; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x6F; g_cpu.S--; func_BA71_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_BBDE:;
    /* $BBDE: 4C */ nes_cpu_instruction_boundary(0xBBDE, 3); nes_cpu_instruction_boundary(0xBAE3, 2); func_BAE3_b4(); return;
...
label_BB21:;
    /* $BB21: 4C */ nes_cpu_instruction_boundary(0xBB21, 3); nes_cpu_instruction_boundary(0xBB4C, 2); func_BB4C_b4(); return;
...
label_BC27:; /* MusicChannelInstr_SongNoteNoise_endIf_A */
    /* $BC27: 4C */ nes_cpu_instruction_boundary(0xBC27, 3); nes_cpu_instruction_boundary(0xBBD8, 2); func_BBD8_b4(); return;
}
...
label_BBF6:;
    /* $BBF6: 4C */ nes_cpu_instruction_boundary(0xBBF6, 3); nes_cpu_instruction_boundary(0xBBFD, 2); func_BBFD_b4(); return;
...
label_BC0B:;
    /* $BC0B: 4C */ nes_cpu_instruction_boundary(0xBC0B, 3); nes_cpu_instruction_boundary(0xBB67, 2); func_BB67_b4(); return;
}
...
label_BAD5:; /* UpdateAllMusicChannels */
    /* $BAD5: 20 */ nes_cpu_instruction_boundary(0xBAD5, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xBA; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xD7; g_cpu.S--; func_BA23_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_BCBD:;
    /* $BCBD: 20 */ nes_cpu_instruction_boundary(0xBCBD, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xBC; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xBF; g_cpu.S--; func_BA14_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_BCC0:;
    /* $BCC0: 20 */ nes_cpu_instruction_boundary(0xBCC0, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xBC; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xC2; g_cpu.S--; func_BF62_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_BCC3:;
    /* $BCC3: 4C */ nes_cpu_instruction_boundary(0xBCC3, 3); nes_cpu_instruction_boundary(0xBAD5, 2); func_BAD5_b4(); return;
}
...
label_BF62:; /* InitializeMusic */
    /* $BF62: 20 */ nes_cpu_instruction_boundary(0xBF62, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xBF; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x64; g_cpu.S--; func_B42C_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_81DA:; /* EnemyIfMoveFailedHorizontal_Bounce_flipSpeed */
    /* $81DA: 20 */ nes_cpu_instruction_boundary(0x81DA, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xDC; g_cpu.S--; func_81F6_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_81DF:;
    /* $81DF: 20 */ nes_cpu_instruction_boundary(0x81DF, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xE1; g_cpu.S--; func_80B0_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_820F:; /* EnemyIfMoveFailedVertical_Bounce_flipSpeed */
    /* $820F: 20 */ nes_cpu_instruction_boundary(0x820F, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x82; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x11; g_cpu.S--; func_81F6_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8214:;
    /* $8214: 20 */ nes_cpu_instruction_boundary(0x8214, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x82; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x16; g_cpu.S--; func_80B0_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
#endif
label_9C49:; /* AreaRoutineStub_BANK4 */
    /* $9C49: 60 */ nes_cpu_instruction_boundary(0x9C49, 6); { g_cpu.S++; uint8_t _rts_lo = g_ram[0x100 + g_cpu.S]; g_cpu.S++; uint8_t _rts_hi = g_ram[0x100 + g_cpu.S]; g_rts_target = (uint16_t)(((uint16_t)_rts_hi << 8) | _rts_lo); } /* pop JSR return address */
...
void func_8B87_b4_body(int _entry) { /* UpdateDoor */
    switch (_entry) {
...
label_8B8C:;
    /* $8B8C: 20 */ nes_cpu_instruction_boundary(0x8B8C, 6); /* inline_dispatch $C27C: 7 entries (bank=4) */
switch(g_cpu.A) {
  ...
  case 1: nes_write(0x006A, g_cpu.Y); nes_write(0x0069, g_cpu.X); nes_write(0x000C, 0x9D); nes_write(0x000D, 0x8B); g_cpu.A = 0x8B; g_cpu.C = 0; FLAG_NZ(g_cpu.Y); nes_cpu_instruction_boundary(0x8B9D, 57); func_8B9D_b4(); return;
  case 2: nes_write(0x006A, g_cpu.Y); nes_write(0x0069, g_cpu.X); nes_write(0x000C, 0xD5); nes_write(0x000D, 0x8B); g_cpu.A = 0x8B; g_cpu.C = 0; FLAG_NZ(g_cpu.Y); nes_cpu_instruction_boundary(0x8BD5, 57); func_8BD5_b4(); return;
  case 3: nes_write(0x006A, g_cpu.Y); nes_write(0x0069, g_cpu.X); nes_write(0x000C, 0x01); nes_write(0x000D, 0x8C); g_cpu.A = 0x8C; g_cpu.C = 0; FLAG_NZ(g_cpu.Y); nes_cpu_instruction_boundary(0x8C01, 57); func_8C01_b4(); return;
  case 4: nes_write(0x006A, g_cpu.Y); nes_write(0x0069, g_cpu.X); nes_write(0x000C, 0x84); nes_write(0x000D, 0x8C); g_cpu.A = 0x8C; g_cpu.C = 0; FLAG_NZ(g_cpu.Y); nes_cpu_instruction_boundary(0x8C84, 57); func_8C84_b4(); return;
  case 5: nes_write(0x006A, g_cpu.Y); nes_write(0x0069, g_cpu.X); nes_write(0x000C, 0xC6); nes_write(0x000D, 0x8C); g_cpu.A = 0x8C; g_cpu.C = 0; FLAG_NZ(g_cpu.Y); nes_cpu_instruction_boundary(0x8CC6, 57); func_8CC6_b4(); return;
  case 6: nes_write(0x006A, g_cpu.Y); nes_write(0x0069, g_cpu.X); nes_write(0x000C, 0xF0); nes_write(0x000D, 0x8C); g_cpu.A = 0x8C; g_cpu.C = 0; FLAG_NZ(g_cpu.Y); nes_cpu_instruction_boundary(0x8CF0, 57); func_8CF0_b4(); return;
...
if (g_cpu.S != _cbs) {
    ...
    return; } }
label_8BA5:;
    /* $8BA5: 20 */ nes_cpu_instruction_boundary(0x8BA5, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x8B; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xA7; g_cpu.S--; func_8CFB_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
void func_81FC_b4_body(int _entry) { /* EnemyIfMoveFailedVertical_Bounce */
    switch (_entry) {
        case 1: goto label_8206;
    }
label_81FC:; /* EnemyIfMoveFailedVertical_Bounce */
    /* $81FC: 20 */ nes_cpu_instruction_boundary(0x81FC, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xFE; g_cpu.S--; func_81F6_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8203:;
    /* $8203: 20 */ nes_cpu_instruction_boundary(0x8203, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x82; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x05; g_cpu.S--; func_856B_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
void func_81C7_b4_body(int _entry) { /* EnemyIfMoveFailedHorizontal_Bounce */
    switch (_entry) {
        case 1: goto label_81D1;
        case 2: goto label_81F5;
    }
label_81C7:; /* EnemyIfMoveFailedHorizontal_Bounce */
    /* $81C7: 20 */ nes_cpu_instruction_boundary(0x81C7, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xC9; g_cpu.S--; func_81F6_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_81CE:;
    /* $81CE: 20 */ nes_cpu_instruction_boundary(0x81CE, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xD0; g_cpu.S--; func_856B_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_81C0:; /* EnemyTriggerResting_AndClearEnAccelX */
    /* $81C0: 20 */ nes_cpu_instruction_boundary(0x81C0, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xC2; g_cpu.S--; func_81B8_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_BB49:; /* GotoUpdateMusicTriLinearCount */
    /* $BB49: 4C */ nes_cpu_instruction_boundary(0xBB49, 3); nes_cpu_instruction_boundary(0xBBE7, 2); func_BBE7_b4(); return;
}
...
label_BB46:; /* GotoMusicChannelInstr_SongNoteNoise */
    /* $BB46: 4C */ nes_cpu_instruction_boundary(0xBB46, 3); nes_cpu_instruction_boundary(0xBC0E, 2); func_BC0E_b4(); return;
}
...
label_BAD1:; /* GotoUpdateAllVolumeEnvelopes */
    /* $BAD1: 20 */ nes_cpu_instruction_boundary(0xBAD1, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xBA; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xD3; g_cpu.S--; func_BA67_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8BFE:;
    /* $8BFE: 4C */ nes_cpu_instruction_boundary(0x8BFE, 3); nes_cpu_instruction_boundary(0x8C7E, 2); func_8C7E_b4(); return;
}

void func_8C01_b4_body(int _entry) { /* UpdateDoor_Open */
    switch (_entry) {
...
label_8C2C:;
    /* $8C2C: 20 */ nes_cpu_instruction_boundary(0x8C2C, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x8C; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x2E; g_cpu.S--; func_8CF7_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8C66:;
    /* $8C66: 20 */ nes_cpu_instruction_boundary(0x8C66, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x8C; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x68; g_cpu.S--; func_8CFB_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8C6E:;
    /* $8C6E: 20 */ nes_cpu_instruction_boundary(0x8C6E, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x8C; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x70; g_cpu.S--; func_8C76_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_8C73:; /* GotoDrawDoor */
    /* $8C73: 4C */ nes_cpu_instruction_boundary(0x8C73, 3); nes_cpu_instruction_boundary(0x8BB1, 2); func_8BB1_b4(); return;
}
...
label_8C8A:;
    /* $8C8A: 20 */ nes_cpu_instruction_boundary(0x8C8A, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x8C; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x8C; g_cpu.S--; func_8CFB_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_8C8D:;
    /* $8C8D: 20 */ nes_cpu_instruction_boundary(0x8C8D, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0x8C; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x8F; g_cpu.S--; func_8C76_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
if (g_cpu.S != _cbs) {
    ...
    return; } }
label_8CC3:;
    /* $8CC3: 4C */ nes_cpu_instruction_boundary(0x8CC3, 3); nes_cpu_instruction_boundary(0x8C71, 2); func_8C71_b4(); return;
}

void func_8CC6_b4_body(int _entry) { /* UpdateDoor_Scroll */
    switch (_entry) {
...
label_8CED:; /* Goto2DrawDoor */
    /* $8CED: 4C */ nes_cpu_instruction_boundary(0x8CED, 3); nes_cpu_instruction_boundary(0x8BB1, 2); func_8BB1_b4(); return;
}
...
label_8CF4:;
    /* $8CF4: 4C */ nes_cpu_instruction_boundary(0x8CF4, 3); nes_cpu_instruction_boundary(0x8C61, 2); func_8C61_b4(); return;
}
...
void func_8CF7_b4_body(int _entry) { /* WriteDoorBGTiles_Air */
    switch (_entry) {
...
#endif
label_A1D1:;
    /* $A1D1: 15 */ nes_cpu_instruction_boundary(0xA1D1, 4); g_cpu.A |= nes_read((0x34 + g_cpu.X) & 0xFF); FLAG_NZ(g_cpu.A);
label_A1D3:;
    /* $A1D3: 29 */ nes_cpu_instruction_boundary(0xA1D3, 2); g_cpu.A &= 0x00; FLAG_NZ(g_cpu.A);
label_A1D5:; /* RoomPtrTable_BANK4 */
    /* $A1D5: B7 */ nes_cpu_instruction_boundary(0xA1D5, 4); g_cpu.A = g_cpu.X = nes_read((0xA2 + g_cpu.Y) & 0xFF); FLAG_NZ(g_cpu.A);
label_A1D7:;
    /* $A1D7: C5 */ nes_cpu_instruction_boundary(0xA1D7, 3); { uint8_t m=nes_read(0xA2); int r=g_cpu.A-m; g_cpu.C=(g_cpu.A>=m)?1:0; FLAG_NZ(r&0xFF); }
label_A1D9:;
    /* $A1D9: CD */ nes_cpu_instruction_boundary(0xA1D9, 4); { uint8_t m=nes_read(0x08A2); int r=g_cpu.A-m; g_cpu.C=(g_cpu.A>=m)?1:0; FLAG_NZ(r&0xFF); }
label_A1DC:;
    /* $A1DC: A3 */ nes_cpu_instruction_boundary(0xA1DC, 6); g_cpu.A = g_cpu.X = nes_read(nes_read16zp((0x45 + g_cpu.X) & 0xFF)); FLAG_NZ(g_cpu.A);
label_A1DE:;
    /* $A1DE: A3 */ nes_cpu_instruction_boundary(0xA1DE, 6); g_cpu.A = g_cpu.X = nes_read(nes_read16zp((0x88 + g_cpu.X) & 0xFF)); FLAG_NZ(g_cpu.A);
label_A1E0:;
    /* $A1E0: A3 */ nes_cpu_instruction_boundary(0xA1E0, 6); g_cpu.A = g_cpu.X = nes_read(nes_read16zp((0xB8 + g_cpu.X) & 0xFF)); FLAG_NZ(g_cpu.A);
label_A1E2:;
    /* $A1E2: A3 */ nes_cpu_instruction_boundary(0xA1E2, 6); g_cpu.A = g_cpu.X = nes_read(nes_read16zp((0x01 + g_cpu.X) & 0xFF)); FLAG_NZ(g_cpu.A);
label_A1E4:;
    /* $A1E4: A4 */ nes_cpu_instruction_boundary(0xA1E4, 3); g_cpu.Y = nes_read(0x42); FLAG_NZ(g_cpu.Y);
label_A1E6:;
    /* $A1E6: A4 */ nes_cpu_instruction_boundary(0xA1E6, 3); g_cpu.Y = nes_read(0x7E); FLAG_NZ(g_cpu.Y);
label_A1E8:;
    /* $A1E8: A4 */ nes_cpu_instruction_boundary(0xA1E8, 3); g_cpu.Y = nes_read(0xAD); FLAG_NZ(g_cpu.Y);
label_A1EA:;
    /* $A1EA: A4 */ nes_cpu_instruction_boundary(0xA1EA, 3); g_cpu.Y = nes_read(0xE2); FLAG_NZ(g_cpu.Y);
label_A1EC:;
    /* $A1EC: A4 */ nes_cpu_instruction_boundary(0xA1EC, 3); g_cpu.Y = nes_read(0x14); FLAG_NZ(g_cpu.Y);
label_A1EE:;
    /* $A1EE: A5 */ nes_cpu_instruction_boundary(0xA1EE, 3); g_cpu.A = nes_read(0x58); FLAG_NZ(g_cpu.A);
label_A1F0:;
    /* $A1F0: A5 */ nes_cpu_instruction_boundary(0xA1F0, 3); g_cpu.A = nes_read(0x90); FLAG_NZ(g_cpu.A);
label_A1F2:;
    /* $A1F2: A5 */ nes_cpu_instruction_boundary(0xA1F2, 3); g_cpu.A = nes_read(0xBF); FLAG_NZ(g_cpu.A);
label_A1F4:;
    /* $A1F4: A5 */ nes_cpu_instruction_boundary(0xA1F4, 3); g_cpu.A = nes_read(0xE8); FLAG_NZ(g_cpu.A);
label_A1F6:;
    /* $A1F6: A5 */ nes_cpu_instruction_boundary(0xA1F6, 3); g_cpu.A = nes_read(0x47); FLAG_NZ(g_cpu.A);
label_A1F8:;
    /* $A1F8: A6 */ nes_cpu_instruction_boundary(0xA1F8, 3); g_cpu.X = nes_read(0x47); FLAG_NZ(g_cpu.X);
label_A1FA:;
    /* $A1FA: A6 */ nes_cpu_instruction_boundary(0xA1FA, 3); g_cpu.X = nes_read(0x83); FLAG_NZ(g_cpu.X);
label_A1FC:;
    /* $A1FC: A6 */ nes_cpu_instruction_boundary(0xA1FC, 3); g_cpu.X = nes_read(0xB5); FLAG_NZ(g_cpu.X);
label_A1FE:;
    /* $A1FE: A6 */ nes_cpu_instruction_boundary(0xA1FE, 3); g_cpu.X = nes_read(0xD9); FLAG_NZ(g_cpu.X);
label_A200:;
    /* $A200: A6 */ nes_cpu_instruction_boundary(0xA200, 3); g_cpu.X = nes_read(0x13); FLAG_NZ(g_cpu.X);
label_A202:;
    /* $A202: A7 */ nes_cpu_instruction_boundary(0xA202, 3); g_cpu.A = g_cpu.X = nes_read(0x45); FLAG_NZ(g_cpu.A);
label_A204:;
    /* $A204: A7 */ nes_cpu_instruction_boundary(0xA204, 3); g_cpu.A = g_cpu.X = nes_read(0x80); FLAG_NZ(g_cpu.A);
label_A206:;
    /* $A206: A7 */ nes_cpu_instruction_boundary(0xA206, 3); g_cpu.A = g_cpu.X = nes_read(0xB2); FLAG_NZ(g_cpu.A);
label_A208:;
    /* $A208: A7 */ nes_cpu_instruction_boundary(0xA208, 3); g_cpu.A = g_cpu.X = nes_read(0xF6); FLAG_NZ(g_cpu.A);
label_A20A:;
    /* $A20A: A7 */ nes_cpu_instruction_boundary(0xA20A, 3); g_cpu.A = g_cpu.X = nes_read(0x3F); FLAG_NZ(g_cpu.A);
label_A20C:;
    /* $A20C: A8 */ nes_cpu_instruction_boundary(0xA20C, 2); g_cpu.Y = g_cpu.A; FLAG_NZ(g_cpu.Y);
label_A20D:;
    /* $A20D: A3 */ nes_cpu_instruction_boundary(0xA20D, 6); g_cpu.A = g_cpu.X = nes_read(nes_read16zp((0xA8 + g_cpu.X) & 0xFF)); FLAG_NZ(g_cpu.A);
label_A20F:;
    /* $A20F: C7 */ nes_cpu_instruction_boundary(0xA20F, 5); { uint16_t a=0xA8; uint8_t v=(nes_read(a)-1)&0xFF; nes_write(a,v); g_cpu.C=(g_cpu.A>=v)?1:0; FLAG_NZ((uint8_t)(g_cpu.A-v)); }
label_A211:;
    /* $A211: 23 */ nes_cpu_instruction_boundary(0xA211, 8); { uint16_t a=nes_read16zp((0xA9 + g_cpu.X) & 0xFF); uint8_t v=nes_read(a); uint8_t c=g_cpu.C; g_cpu.C=(v>>7)&1; v=((v<<1)|c)&0xFF; nes_write(a,v); g_cpu.A&=v; FLAG_NZ(g_cpu.A); }
label_A213:;
    /* $A213: 4F */ nes_cpu_instruction_boundary(0xA213, 6); { uint16_t a=0x72A9; uint8_t v=nes_read(a); g_cpu.C=v&1; v>>=1; nes_write(a,v); g_cpu.A^=v; FLAG_NZ(g_cpu.A); }
label_A216:;
    /* $A216: A9 */ nes_cpu_instruction_boundary(0xA216, 2); g_cpu.A = 0x90; FLAG_NZ(g_cpu.A);
label_A218:;
    /* $A218: A9 */ nes_cpu_instruction_boundary(0xA218, 2); g_cpu.A = 0xBE; FLAG_NZ(g_cpu.A);
label_A21A:;
    /* $A21A: A9 */ nes_cpu_instruction_boundary(0xA21A, 2); g_cpu.A = 0xFE; FLAG_NZ(g_cpu.A);
label_A21C:;
    /* $A21C: A9 */ nes_cpu_instruction_boundary(0xA21C, 2); g_cpu.A = 0x33; FLAG_NZ(g_cpu.A);
label_A21E:;
    /* $A21E: AA */ nes_cpu_instruction_boundary(0xA21E, 2); g_cpu.X = g_cpu.A; FLAG_NZ(g_cpu.X);
label_A21F:; /* StructPtrTable_BANK4 */
    /* $A21F: 6B */ nes_cpu_instruction_boundary(0xA21F, 2); { g_cpu.A &= 0xAA; uint8_t c=g_cpu.C; g_cpu.A=((g_cpu.A>>1)|(c<<7))&0xFF; FLAG_NZ(g_cpu.A); g_cpu.C=(g_cpu.A>>6)&1; g_cpu.V=(((g_cpu.A>>6)&1)^((g_cpu.A>>5)&1)); }
label_A221:;
    /* $A221: 7E */ nes_cpu_instruction_boundary(0xA221, 7); { uint16_t a=(0x97AA + g_cpu.X) & 0xFFFF; uint8_t v=nes_read(a); uint8_t c=g_cpu.C; g_cpu.C=v&1; v=((v>>1)|(c<<7))&0xFF; nes_write(a,v); FLAG_NZ(v); }
label_A224:;
    /* $A224: AA */ nes_cpu_instruction_boundary(0xA224, 2); g_cpu.X = g_cpu.A; FLAG_NZ(g_cpu.X);
label_A225:;
    /* $A225: B0 */ nes_cpu_instruction_boundary(0xA225, 2); if (g_cpu.C) {
    nes_cpu_instruction_boundary(0xA1D1, 2);
#ifdef WATCHDOG_ENABLED
    watchdog_check();
#endif
    goto label_A1D1;
...
label_A227:;
    /* $A227: B7 */ nes_cpu_instruction_boundary(0xA227, 4); g_cpu.A = g_cpu.X = nes_read((0xAA + g_cpu.Y) & 0xFF); FLAG_NZ(g_cpu.A);
label_A229:;
    /* $A229: BE */ nes_cpu_instruction_boundary(0xA229, 4); g_cpu.X = nes_read((0xC2AA + g_cpu.Y) & 0xFFFF); FLAG_NZ(g_cpu.X);
label_A22C:;
    /* $A22C: AA */ nes_cpu_instruction_boundary(0xA22C, 2); g_cpu.X = g_cpu.A; FLAG_NZ(g_cpu.X);
label_A22D:;
    /* $A22D: D2 */ nes_cpu_instruction_boundary(0xA22D, 2); /* ILLEGAL $D2 — skip 1 */
label_A22E:;
    /* $A22E: AA */ nes_cpu_instruction_boundary(0xA22E, 2); g_cpu.X = g_cpu.A; FLAG_NZ(g_cpu.X);
label_A22F:;
    /* $A22F: E2 */ nes_cpu_instruction_boundary(0xA22F, 2); /* NOP */
label_A231:;
    /* $A231: E7 */ nes_cpu_instruction_boundary(0xA231, 5); { uint16_t a=0xAA; uint8_t v=(nes_read(a)+1)&0xFF; nes_write(a,v); int16_t r=g_cpu.A-v-(1-g_cpu.C); FLAG_NZC_SUB(r,g_cpu.A,v); g_cpu.A=r&0xFF; }
label_A233:;
    /* $A233: EC */ nes_cpu_instruction_boundary(0xA233, 4); { uint8_t m=nes_read(0xEFAA); int r=g_cpu.X-m; g_cpu.C=(g_cpu.X>=m)?1:0; FLAG_NZ(r&0xFF); }
label_A236:;
    /* $A236: AA */ nes_cpu_instruction_boundary(0xA236, 2); g_cpu.X = g_cpu.A; FLAG_NZ(g_cpu.X);
label_A237:;
    /* $A237: F2 */ nes_cpu_instruction_boundary(0xA237, 2); /* ILLEGAL $F2 — skip 1 */
label_A238:;
    /* $A238: AA */ nes_cpu_instruction_boundary(0xA238, 2); g_cpu.X = g_cpu.A; FLAG_NZ(g_cpu.X);
label_A239:;
    /* $A239: FD */ nes_cpu_instruction_boundary(0xA239, 4); { uint8_t m=nes_read((0x03AA + g_cpu.X) & 0xFFFF); int16_t r=g_cpu.A-m-(1-g_cpu.C); FLAG_NZC_SUB(r,g_cpu.A,m); g_cpu.A=r&0xFF; }
label_A23C:;
    /* $A23C: AB */ nes_cpu_instruction_boundary(0xA23C, 2); g_cpu.A = g_cpu.X = 0x08; FLAG_NZ(g_cpu.A);
label_A23E:;
    /* $A23E: AB */ nes_cpu_instruction_boundary(0xA23E, 2); g_cpu.A = g_cpu.X = 0x11; FLAG_NZ(g_cpu.A);
label_A240:;
    /* $A240: AB */ nes_cpu_instruction_boundary(0xA240, 2); g_cpu.A = g_cpu.X = 0x26; FLAG_NZ(g_cpu.A);
label_A242:;
    /* $A242: AB */ nes_cpu_instruction_boundary(0xA242, 2); g_cpu.A = g_cpu.X = 0x29; FLAG_NZ(g_cpu.A);
label_A244:;
    /* $A244: AB */ nes_cpu_instruction_boundary(0xA244, 2); g_cpu.A = g_cpu.X = 0x3C; FLAG_NZ(g_cpu.A);
label_A246:;
    /* $A246: AB */ nes_cpu_instruction_boundary(0xA246, 2); g_cpu.A = g_cpu.X = 0x51; FLAG_NZ(g_cpu.A);
label_A248:;
    /* $A248: AB */ nes_cpu_instruction_boundary(0xA248, 2); g_cpu.A = g_cpu.X = 0x55; FLAG_NZ(g_cpu.A);
label_A24A:;
    /* $A24A: AB */ nes_cpu_instruction_boundary(0xA24A, 2); g_cpu.A = g_cpu.X = 0x68; FLAG_NZ(g_cpu.A);
label_A24C:;
    /* $A24C: AB */ nes_cpu_instruction_boundary(0xA24C, 2); g_cpu.A = g_cpu.X = 0x75; FLAG_NZ(g_cpu.A);
label_A24E:;
    /* $A24E: AB */ nes_cpu_instruction_boundary(0xA24E, 2); g_cpu.A = g_cpu.X = 0x88; FLAG_NZ(g_cpu.A);
label_A250:;
    /* $A250: AB */ nes_cpu_instruction_boundary(0xA250, 2); g_cpu.A = g_cpu.X = 0x9B; FLAG_NZ(g_cpu.A);
label_A252:;
    /* $A252: AB */ nes_cpu_instruction_boundary(0xA252, 2); g_cpu.A = g_cpu.X = 0xB0; FLAG_NZ(g_cpu.A);
label_A254:;
    /* $A254: AB */ nes_cpu_instruction_boundary(0xA254, 2); g_cpu.A = g_cpu.X = 0xBA; FLAG_NZ(g_cpu.A);
label_A256:;
    /* $A256: AB */ nes_cpu_instruction_boundary(0xA256, 2); g_cpu.A = g_cpu.X = 0xBD; FLAG_NZ(g_cpu.A);
label_A258:;
    /* $A258: AB */ nes_cpu_instruction_boundary(0xA258, 2); g_cpu.A = g_cpu.X = 0xC4; FLAG_NZ(g_cpu.A);
label_A25A:;
    /* $A25A: AB */ nes_cpu_instruction_boundary(0xA25A, 2); g_cpu.A = g_cpu.X = 0xE0; FLAG_NZ(g_cpu.A);
label_A25C:;
    /* $A25C: AB */ nes_cpu_instruction_boundary(0xA25C, 2); g_cpu.A = g_cpu.X = 0xE9; FLAG_NZ(g_cpu.A);
label_A25E:;
    /* $A25E: AB */ nes_cpu_instruction_boundary(0xA25E, 2); g_cpu.A = g_cpu.X = 0xFE; FLAG_NZ(g_cpu.A);
label_A260:;
    /* $A260: AB */ nes_cpu_instruction_boundary(0xA260, 2); g_cpu.A = g_cpu.X = 0x01; FLAG_NZ(g_cpu.A);
label_A262:;
    /* $A262: AC */ nes_cpu_instruction_boundary(0xA262, 4); g_cpu.Y = nes_read(0xAC0A); FLAG_NZ(g_cpu.Y);
label_A265:;
    /* $A265: 0F */ nes_cpu_instruction_boundary(0xA265, 6); { uint16_t a=0x14AC; uint8_t v=nes_read(a); g_cpu.C=(v>>7)&1; v=(v<<1)&0xFF; nes_write(a,v); g_cpu.A|=v; FLAG_NZ(g_cpu.A); }
label_A268:;
    /* $A268: AC */ nes_cpu_instruction_boundary(0xA268, 4); g_cpu.Y = nes_read(0xAC1E); FLAG_NZ(g_cpu.Y);
label_A26B:;
    /* $A26B: 27 */ nes_cpu_instruction_boundary(0xA26B, 5); { uint16_t a=0xAC; uint8_t v=nes_read(a); uint8_t c=g_cpu.C; g_cpu.C=(v>>7)&1; v=((v<<1)|c)&0xFF; nes_write(a,v); g_cpu.A&=v; FLAG_NZ(g_cpu.A); }
label_A26D:; /* SpecItmsTbl_BANK4 */
    /* $A26D: 12 */ nes_cpu_instruction_boundary(0xA26D, 2); /* ILLEGAL $12 — skip 1 */
label_A26E:;
    /* $A26E: 75 */ nes_cpu_instruction_boundary(0xA26E, 4); { uint8_t m=nes_read((0xA2 + g_cpu.X) & 0xFF); uint16_t r=g_cpu.A+m+g_cpu.C; FLAG_NZC_ADD(r,g_cpu.A,m); g_cpu.A=r&0xFF; }
label_A270:; /* SpecItmsTbl_BANK4_y12_x07 */
    /* $A270: 07 */ nes_cpu_instruction_boundary(0xA270, 5); { uint16_t a=0xFF; uint8_t v=nes_read(a); g_cpu.C=(v>>7)&1; v=(v<<1)&0xFF; nes_write(a,v); g_cpu.A|=v; FLAG_NZ(g_cpu.A); }
label_A272:;
    /* $A272: 04 */ nes_cpu_instruction_boundary(0xA272, 3); (void)nes_read(0x81); /* NOP* (unofficial DOP/TOP read, result discarded) */
label_A274:;
    /* $A274: 00 */ nes_cpu_instruction_boundary(0xA274, 7); nes_brk_executed(0xA274); return;
}
...
label_B6E0:; /* MissilePickupSFXCont */
    /* $B6E0: 20 */ nes_cpu_instruction_boundary(0xB6E0, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB6; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xE2; g_cpu.S--; func_B4D9_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B6ED:;
    /* $B6ED: 4C */ nes_cpu_instruction_boundary(0xB6ED, 3); nes_cpu_instruction_boundary(0xB722, 2); func_B722_b4(); return;
...
label_B703:; /* EnergyPickupSFXCont */
    /* $B703: 20 */ nes_cpu_instruction_boundary(0xB703, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB7; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x05; g_cpu.S--; func_B4D9_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B714:;
    /* $B714: 4C */ nes_cpu_instruction_boundary(0xB714, 3); nes_cpu_instruction_boundary(0xB398, 2); func_B398_b4(); return;
label_B722:; /* EndSQ1SFX */
    /* $B722: A9 */ nes_cpu_instruction_boundary(0xB722, 2); g_cpu.A = 0x10; FLAG_NZ(g_cpu.A);
label_B724:;
    /* $B724: 8D */ nes_cpu_instruction_boundary(0xB724, 4); nes_write(0x4000, g_cpu.A);
...
label_B71D:; /* SQ1SFXCont */
    /* $B71D: 20 */ nes_cpu_instruction_boundary(0xB71D, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB7; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x1F; g_cpu.S--; func_B4D9_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B785:;
    /* $B785: 20 */ nes_cpu_instruction_boundary(0xB785, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB7; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x87; g_cpu.S--; func_B4D9_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B78A:;
    /* $B78A: 4C */ nes_cpu_instruction_boundary(0xB78A, 3); nes_cpu_instruction_boundary(0xB722, 2); func_B722_b4(); return;
...
label_B792:;
    /* $B792: 4C */ nes_cpu_instruction_boundary(0xB792, 3); nes_cpu_instruction_boundary(0xB482, 2); func_B482_b4(); return;
label_B795:; /* HasIceBeamSFXCont */
    /* $B795: 20 */ nes_cpu_instruction_boundary(0xB795, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB7; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x97; g_cpu.S--; func_B4D9_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B79A:;
    /* $B79A: 4C */ nes_cpu_instruction_boundary(0xB79A, 3); nes_cpu_instruction_boundary(0xB722, 2); func_B722_b4(); return;
...
label_B7AE:;
    /* $B7AE: 4C */ nes_cpu_instruction_boundary(0xB7AE, 3); nes_cpu_instruction_boundary(0xB482, 2); func_B482_b4(); return;
...
label_B7B1:; /* WaveBeamSFXCont */
    /* $B7B1: 20 */ nes_cpu_instruction_boundary(0xB7B1, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB7; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xB3; g_cpu.S--; func_B4D9_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B7C4:;
    /* $B7C4: 4C */ nes_cpu_instruction_boundary(0xB7C4, 3); nes_cpu_instruction_boundary(0xB722, 2); func_B722_b4(); return;
...
label_B902:; /* SamusDieSFXInit */
    /* $B902: 20 */ nes_cpu_instruction_boundary(0xB902, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB9; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x04; g_cpu.S--; func_B434_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B909:;
    /* $B909: 20 */ nes_cpu_instruction_boundary(0xB909, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB9; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x0B; g_cpu.S--; func_B482_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B7F8:;
    /* $B7F8: 4C */ nes_cpu_instruction_boundary(0xB7F8, 3); nes_cpu_instruction_boundary(0xB482, 2); func_B482_b4(); return;
}
...
label_B8DB:;
    /* $B8DB: 20 */ nes_cpu_instruction_boundary(0xB8DB, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB8; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xDD; g_cpu.S--; func_B482_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_B8DE:;
    /* $B8DE: 4C */ nes_cpu_instruction_boundary(0xB8DE, 3); nes_cpu_instruction_boundary(0xB8F3, 2); func_B8F3_b4(); return;
}
...
label_B96D:;
    /* $B96D: 4C */ nes_cpu_instruction_boundary(0xB96D, 3); nes_cpu_instruction_boundary(0xB482, 2); func_B482_b4(); return;
}
...
label_B814:;
    /* $B814: 4C */ nes_cpu_instruction_boundary(0xB814, 3); nes_cpu_instruction_boundary(0xB482, 2); func_B482_b4(); return;
}
...
label_B83B:;
    /* $B83B: 4C */ nes_cpu_instruction_boundary(0xB83B, 3); nes_cpu_instruction_boundary(0xB482, 2); func_B482_b4(); return;
}
...
label_B868:;
    /* $B868: 20 */ nes_cpu_instruction_boundary(0xB868, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB8; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x6A; g_cpu.S--; func_B482_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B8AC:;
    /* $B8AC: 4C */ nes_cpu_instruction_boundary(0xB8AC, 3); nes_cpu_instruction_boundary(0xB482, 2); func_B482_b4(); return;
}
...
label_B91D:; /* SamusDieSFXCont */
    /* $B91D: 20 */ nes_cpu_instruction_boundary(0xB91D, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB9; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x1F; g_cpu.S--; func_B4D9_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B7FB:; /* DoorOpenCloseSFXCont */
    /* $B7FB: 20 */ nes_cpu_instruction_boundary(0xB7FB, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB7; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xFD; g_cpu.S--; func_B4D9_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B800:;
    /* $B800: 4C */ nes_cpu_instruction_boundary(0xB800, 3); nes_cpu_instruction_boundary(0xB8C6, 2); func_B8C6_b4(); return;
label_B803:; /* DoorOpenCloseSFXCont_endIf_A */
    /* $B803: 20 */ nes_cpu_instruction_boundary(0xB803, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB8; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x05; g_cpu.S--; func_B9BC_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_B806:;
    /* $B806: 4C */ nes_cpu_instruction_boundary(0xB806, 3); nes_cpu_instruction_boundary(0xB899, 2); func_B899_b4(); return;
}
...
label_B8E1:; /* MetroidHitSFXCont */
    /* $B8E1: 20 */ nes_cpu_instruction_boundary(0xB8E1, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB8; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xE3; g_cpu.S--; func_B4D9_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B8F0:;
    /* $B8F0: 4C */ nes_cpu_instruction_boundary(0xB8F0, 3); nes_cpu_instruction_boundary(0xB8C6, 2); func_B8C6_b4(); return;
label_B8F3:; /* RndTriPeriods */
    /* $B8F3: A5 */ nes_cpu_instruction_boundary(0xB8F3, 3); g_cpu.A = nes_read(0x2E); FLAG_NZ(g_cpu.A);
label_B8F5:;
    /* $B8F5: 09 */ nes_cpu_instruction_boundary(0xB8F5, 2); g_cpu.A |= 0x6C; FLAG_NZ(g_cpu.A);
...
void func_B970_b4_body(int _entry) { /* StatueRaiseSFXCont */
    switch (_entry) {
        case 1: goto label_B978;
    }
label_B970:; /* StatueRaiseSFXCont */
    /* $B970: 20 */ nes_cpu_instruction_boundary(0xB970, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB9; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x72; g_cpu.S--; func_B4D9_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B97F:;
    /* $B97F: 4C */ nes_cpu_instruction_boundary(0xB97F, 3); nes_cpu_instruction_boundary(0xB8C6, 2); func_B8C6_b4(); return;
...
label_B994:;
    /* $B994: 20 */ nes_cpu_instruction_boundary(0xB994, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB9; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x96; g_cpu.S--; func_B9A8_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B99F:;
    /* $B99F: 4C */ nes_cpu_instruction_boundary(0xB99F, 3); nes_cpu_instruction_boundary(0xB899, 2); func_B899_b4(); return;
label_B9A2:; /* StatueRaiseSFXCont_endIf_A */
    /* $B9A2: 20 */ nes_cpu_instruction_boundary(0xB9A2, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB9; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xA4; g_cpu.S--; func_B9BC_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
    ...
    return; } }
label_B9A5:;
    /* $B9A5: 4C */ nes_cpu_instruction_boundary(0xB9A5, 3); nes_cpu_instruction_boundary(0xB899, 2); func_B899_b4(); return;
}
...
label_B817:; /* BeepSFXCont */
    /* $B817: 20 */ nes_cpu_instruction_boundary(0xB817, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB8; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x19; g_cpu.S--; func_B4D9_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B81C:;
    /* $B81C: 4C */ nes_cpu_instruction_boundary(0xB81C, 3); nes_cpu_instruction_boundary(0xB8C6, 2); func_B8C6_b4(); return;
}
...
label_B83E:; /* BigEnemyHitSFXCont */
    /* $B83E: 20 */ nes_cpu_instruction_boundary(0xB83E, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB8; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x40; g_cpu.S--; func_B4D9_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B843:;
    /* $B843: 4C */ nes_cpu_instruction_boundary(0xB843, 3); nes_cpu_instruction_boundary(0xB8C6, 2); func_B8C6_b4(); return;
label_B846:; /* BigEnemyHitSFXCont_dontEnd */
    /* $B846: 20 */ nes_cpu_instruction_boundary(0xB846, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB8; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x48; g_cpu.S--; func_B9A8_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B87F:; /* SamusToBallSFXCont */
    /* $B87F: 20 */ nes_cpu_instruction_boundary(0xB87F, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB8; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x81; g_cpu.S--; func_B4D9_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B884:;
    /* $B884: 4C */ nes_cpu_instruction_boundary(0xB884, 3); nes_cpu_instruction_boundary(0xB8C6, 2); func_B8C6_b4(); return;
label_B887:;
    /* $B887: 20 */ nes_cpu_instruction_boundary(0xB887, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB8; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x89; g_cpu.S--; func_B9D0_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B896:;
    /* $B896: 20 */ nes_cpu_instruction_boundary(0xB896, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB8; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x98; g_cpu.S--; func_B9BC_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B8AF:; /* BombLaunchSFXCont */
    /* $B8AF: 20 */ nes_cpu_instruction_boundary(0xB8AF, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB8; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xB1; g_cpu.S--; func_B4D9_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B8BE:;
    /* $B8BE: 4C */ nes_cpu_instruction_boundary(0xB8BE, 3); nes_cpu_instruction_boundary(0xB8C6, 2); func_B8C6_b4(); return;
label_B8C1:; /* BombLaunchSFXCont_endIf_A */
    /* $B8C1: A0 */ nes_cpu_instruction_boundary(0xB8C1, 2); g_cpu.Y = 0x99; FLAG_NZ(g_cpu.Y);
label_B8C3:;
    /* $B8C3: 4C */ nes_cpu_instruction_boundary(0xB8C3, 3); nes_cpu_instruction_boundary(0xB39C, 2); func_B39C_b4(); return;
label_B8D6:; /* EndTriSFX_RTS */
    /* $B8D6: 60 */ nes_cpu_instruction_boundary(0xB8D6, 6); { g_cpu.S++; uint8_t _rts_lo = g_ram[0x100 + g_cpu.S]; g_cpu.S++; uint8_t _rts_hi = g_ram[0x100 + g_cpu.S]; g_rts_target = (uint16_t)(((uint16_t)_rts_hi << 8) | _rts_lo); } /* pop JSR return address */
...
label_BCAA:; /* GotoMusic01Init */
    /* $BCAA: 4C */ nes_cpu_instruction_boundary(0xBCAA, 3); nes_cpu_instruction_boundary(0xBCD4, 2); func_BCD4_b4(); return;
}
...
label_B6A5:;
    /* $B6A5: 20 */ nes_cpu_instruction_boundary(0xB6A5, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB6; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xA7; g_cpu.S--; func_B398_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B6B8:;
    /* $B6B8: 20 */ nes_cpu_instruction_boundary(0xB6B8, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB6; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xBA; g_cpu.S--; func_B5D5_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B61E:;
    /* $B61E: 20 */ nes_cpu_instruction_boundary(0xB61E, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB6; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x20; g_cpu.S--; func_B398_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B623:;
    /* $B623: 4C */ nes_cpu_instruction_boundary(0xB623, 3); nes_cpu_instruction_boundary(0xB5D5, 2); func_B5D5_b4(); return;
}
...
label_B6C7:;
    /* $B6C7: 20 */ nes_cpu_instruction_boundary(0xB6C7, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB6; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xC9; g_cpu.S--; func_B398_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B6CE:;
    /* $B6CE: 4C */ nes_cpu_instruction_boundary(0xB6CE, 3); nes_cpu_instruction_boundary(0xB5D5, 2); func_B5D5_b4(); return;
}
...
label_B680:; /* SamusHitSFXCont */
    /* $B680: 20 */ nes_cpu_instruction_boundary(0xB680, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB6; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x82; g_cpu.S--; func_B4D9_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B685:;
    /* $B685: 4C */ nes_cpu_instruction_boundary(0xB685, 3); nes_cpu_instruction_boundary(0xB5FD, 2); func_B5FD_b4(); return;
label_B688:; /* SamusHitSFXCont_endIf_A */
    /* $B688: A0 */ nes_cpu_instruction_boundary(0xB688, 2); g_cpu.Y = 0x55; FLAG_NZ(g_cpu.Y);
label_B68A:;
    /* $B68A: 20 */ nes_cpu_instruction_boundary(0xB68A, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB6; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x8C; g_cpu.S--; func_B398_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B696:;
    /* $B696: 20 */ nes_cpu_instruction_boundary(0xB696, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB6; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0x98; g_cpu.S--; func_B3A4_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B64D:;
    /* $B64D: 4C */ nes_cpu_instruction_boundary(0xB64D, 3); nes_cpu_instruction_boundary(0xB65C, 2); func_B65C_b4(); return;
...
label_B669:; /* GotoEndMultiSFX */
    /* $B669: 4C */ nes_cpu_instruction_boundary(0xB669, 3); nes_cpu_instruction_boundary(0xB5FD, 2); func_B5FD_b4(); return;
}
...
label_B6D1:; /* IncorrectPasswordSFXCont */
    /* $B6D1: 20 */ nes_cpu_instruction_boundary(0xB6D1, 6); { uint8_t _cbs = g_cpu.S; g_ram[0x100 + g_cpu.S] = 0xB6; g_cpu.S--; g_ram[0x100 + g_cpu.S] = 0xD3; g_cpu.S--; func_B4D9_b4();
if (g_cpu.S != _cbs) {
#ifdef RECOMP_STACK_TRACKING
...
label_B6D6:;
    /* $B6D6: 4C */ nes_cpu_instruction_boundary(0xB6D6, 3); nes_cpu_instruction_boundary(0xB5FD, 2); func_B5FD_b4(); return;
}
...
label_B591:;
    /* $B591: 4C */ nes_cpu_instruction_boundary(0xB591, 3); nes_cpu_instruction_boundary(0xB5BF, 2); func_B5BF_b4(); return;
}
...
void func_B9E5_b4_body(int _entry) { /* DivideSFXTriPeriod_loop */
    switch (_entry) {
...
void func_C2BF_b4_body(int _entry) { /* Adiv16 */
    switch (_entry) {
...
void func_CBDA_b4_body(int _entry) { /* SFX_Door */
    switch (_entry) {
