...
void func_8068_b0_body(int _entry) {
    switch (_entry) {
...
void func_B3F0_b0_body(int _entry) {
    switch (_entry) {
...
void func_B493_b0_body(int _entry) {
    switch (_entry) {
...
void func_B978_b0_body(int _entry) {
    switch (_entry) {
...
void func_B2FC_b0_body(int _entry) {
    switch (_entry) {
