...
REPO_NAME="MetroidNESRecomp"      # GitHub repo / zip basename
APP_NAME="Metroid"        # .app display name (may contain spaces)
TARGET="MetroidNESRecomp"            # cmake target == built binary filename in build-mac/
SYSTEM="nes"            # nes | snes | genesis | vb | psx
VERSION="v0.0.2-macos"          # release tag, e.g. v0.1.0-macos
ROM_HINT="Metroid (USA) .nes dump"        # human description of the ROM the user must supply
# ==============================================
